...
Public Class ChalanAndGatePassIssue
    ...
    Private Sub BindDataGrid(ByVal strArg As String)
        ...
        Catch exp As Exception
            ...
            lblMessage.Text = "Line : " & Mid(strsql, InStr(strsql, "line") + 5) & " Message : " + exp.Message
        End Try
        'Pankaj Motwani:Message displayed in Line no should be replaced by user readable understanable message'
        con.Close()
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        If doneC = False Then
            ...
            Exit Sub
        Else
            'Pankaj Motwani: After message like record exist, cursor should be placed at  user input text field'
            done = save()
            If done Then
                sendSMS()
    ...
    Protected Sub GetDetails()
        ...
        cmd.CommandText = "select Despatch_Date,Consignee_Name,Wheel_Type,Drawing_No,Specification_No,WtaNumber,WtaDate,Rail_Letter,LorryNo,Driver_Name,Driver_ID,Rep_Name,Rep_ContactNo,Quantity,LRCNno,LRDate,RoadPermit,Contractor_Name from mm_despatchMemo where Memo_No='" & ddlmemo.SelectedItem.Text & "'"
        ...
        Try
            ...
            Using sdr As SqlDataReader = cmd.ExecuteReader()
                ...
                txtwta.Text = sdr("WtaNumber").ToString()
    ...
    Protected Sub sendSMS()
        ...
        'Pankaj Motwani: Such messge should appear in message box and unless and untill it is clicked by user parent form should not be actiavted.
        Dim cmd As SqlClient.SqlCommand = rwfGen.Connection.CmdObj
            cmd.Connection.Open()
