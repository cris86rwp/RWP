...
Public Class WheelDespatch
    ...
    Private Sub BindDataGrid(ByVal strArg As String)
        ...
        Catch exp As SqlException
            strsql = exp.StackTrace
            lblMessage.Text = "Line : " & Mid(strsql, InStr(strsql, "line") + 5) & " Message : " + exp.Message
            'Pankaj Motwani: Line no in messagebox should be replaced with user understandable message string.'
        Catch exp As Exception
            strsql = exp.StackTrace
            lblMessage.Text = "Line : " & Mid(strsql, InStr(strsql, "line") + 5) & " Message : " + exp.Message
        End Try
    ...
    Protected Sub sendSMS()
        ...
        'Pankaj Motwani: Mesage like above should be displayed in message box on top of parent form'. 
        'Parent Form should remain deactivated till message box is clicked'
        Dim cmd As SqlClient.SqlCommand = rwfGen.Connection.CmdObj
        cmd.Connection.Open()
