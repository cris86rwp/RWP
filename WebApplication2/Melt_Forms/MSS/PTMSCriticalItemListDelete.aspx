<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PTMSCriticalItemListDelete.aspx.vb" Inherits="WebApplication2.PTMSCriticalItemListDelete" smartNavigation="True" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head runat="server">
		<title>PTMSCriticalItemListDelete</title>
        ...
        <a class="nav-link p-0" href="#">
         ...
         <div class="container">
			...
			<%--<table id="Table1" class="table">
              <%--  style="Z-INDEX: 101; LEFT: 7px; POSITION: absolute; TOP: 3px" cellSpacing="1" cellPadding="1" width="300"--%>
			<%--	</table>--%>
					
				<table id="Table2" class="table">
                            <%--style="WIDTH: 363px; HEIGHT: 86px" cellSpacing="1" cellPadding="1" width="363"--%>
							<tr>
								
                                   
                                <td colspan="3" style=" color: #FFFFFF;">
										<asp:label id="lblConsignee" runat="server" ForeColor="White"></asp:label>
                                    &nbsp;Critical&nbsp;List - Delete<hr class="prettyline" /></td>
							</tr>
							<tr>
						...
						<table id="Table3" class="table">
							...
							<tr>
								...
								<td style=" color: #FFFFFF;">:</td>
								<td colSpan="4">
									<asp:textbox id="txtSup" runat="server"  CssClass="form-control"></asp:textbox> </td>
						...
						<asp:datagrid id="dgSavedData"  CssClass="table" runat="server" >
