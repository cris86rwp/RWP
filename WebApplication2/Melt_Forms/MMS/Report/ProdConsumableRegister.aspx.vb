...
#End Region
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        If Not Done Then
            ...
            Select Case rblType.SelectedItem.Value
                Case 1
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=16437&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=cris-bela@1234567890&promptonrefresh=0" &
                    ...
                    "&promptex3=0" &
                    "&user0@ProdConsumableRegisterMultipleSummary.rpt=crissqlserver&password0@ProdConsumableRegisterMultipleSummary.rpt=cris-bela@1234567890"
                Case 2
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=16430&user0=crissqlserver&password0=cris-bela@1234567890" &
                    "&promptex0=DateTime(" & CDate(txtFrDt.Text).Year & "," & CDate(txtFrDt.Text).Month & "," & CDate(txtFrDt.Text).Day & ", 0,0,0)" &
                    "&promptex1=DateTime(" & CDate(txtToDt.Text).Year & "," & CDate(txtToDt.Text).Month & "," & CDate(txtToDt.Text).Day & ", 0,0,0)" &
                    "&promptex2=" & ddlPLs.SelectedItem.Value & "" &
                    "&promptex3=0" &
                    "&user0@ProdConsumableRegisterMultipleSummary.rpt=crissqlserver&password0@ProdConsumableRegisterMultipleSummary.rpt=cris-bela@1234567890"
                Case 3
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=16359&user0=crissqlserver&password0=cris-bela@1234567890" &
                    "&promptex0=DateTime(" & CDate(txtFrDt.Text).Year & "," & CDate(txtFrDt.Text).Month & "," & CDate(txtFrDt.Text).Day & ", 0,0,0)" &
                    "&promptex1=DateTime(" & CDate(txtToDt.Text).Year & "," & CDate(txtToDt.Text).Month & "," & CDate(txtToDt.Text).Day & ", 0,0,0)" &
                    "&promptex2=0" &
                    "&promptex3=" & ddlPLs.SelectedItem.Value & "" &
                    "&user0@Supplier.rpt=crissqlserver&password0@Supplier.rpt=cris-bela@1234567890"
                Case 4
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=16445&user0=crissqlserver&password0=cris-bela@1234567890" &
                    "&promptex0=DateTime(" & CDate(txtFrDt.Text).Year & "," & CDate(txtFrDt.Text).Month & "," & CDate(txtFrDt.Text).Day & ", 0,0,0)" &
                    "&promptex1=DateTime(" & CDate(txtToDt.Text).Year & "," & CDate(txtToDt.Text).Month & "," & CDate(txtToDt.Text).Day & ", 0,0,0)" &
                    "&promptex2=ALL" &
                    "&promptex3=1" &
                    "&user0@ProdConsumableRegisterMultipleSummary.rpt=crissqlserver&password0@ProdConsumableRegisterMultipleSummary.rpt=cris-bela@1234567890"
                Case 5
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=13740&user0=crissqlserver&password0=cris-bela@1234567890" &
                    "&promptex0=DateTime(" & CDate(txtFrDt.Text).Year & "," & CDate(txtFrDt.Text).Month & "," & CDate(txtFrDt.Text).Day & ", 0,0,0)" &
                    "&promptex1=DateTime(" & CDate(txtToDt.Text).Year & "," & CDate(txtToDt.Text).Month & "," & CDate(txtToDt.Text).Day & ", 0,0,0)" &
                    "&promptex2=" & ddlPLs.SelectedItem.Value & "" &
                    "&promptex3=2"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=13707&user0=crissqlserver&password0=cris-bela@1234567890" &
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=18517&user0=crissqlserver&password0=cris-bela@1234567890" &
