...
#End Region
    ...
    Private Sub ClearPostMelt()
        ...
        txtTap_beginHr.Text = Right(("0" + Now.Hour.ToString), 2)
            ...
            If ds.Tables(1).Rows.Count > 0 Then
                ...
                If IsDBNull(ds.Tables(1).Rows(0)("heat_tapped")) Then
                    ...
                    If mystr <> "" Then
                        ...
                        End If
                    End If
                    txtTap_beginHr.Text = Left(("0" + myHr), 2)
                ...
                Else
                    ...
                    txtTap_beginHr.Text = Right("0" + (CDate(ds.Tables(1).Rows(0)("heat_tapped")).Hour.ToString), 2)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            done = New RWF.Melting().SaveHeatSheet(CLng(ViewState("Heat")), FurNo.SelectedItem.Text.Trim, CDate(txtDate.Text), rblShift.SelectedItem.Text, txtShift_incharge.Text.Trim, txtFurnace_incharge.Text.Trim, DDLWO.SelectedItem.Value)
            done = True
            If done Then
                done = False
    ...
    Private Sub btnSheet2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSheet2.Click
        ...
        If Not Session("UserId") = "082616" Then
            ...
            End If
        End If
        Dim Power_t2, Power_t6, Charge_met, Bucket_charge, Bucket_chargemet, Roof_in, Furnace, Roof_out, Charge_start, Charge_end, removed_material, Levelling As Date
        lblMessage.Text = ""
        Try
        ...
        Dim done As Boolean
        Try
            done = New RWF.Melting().SaveHeatLog(CLng(ViewState("Heat")), Furnace, Roof_out, Charge_start, Charge_end, removed_material, Levelling, Roof_in, Bucket_chargemet, Bucket_charge, Charge_met, Power_t6, Power_t2)
            If done Then
                done = False
    ...
    Protected Sub DDLSOS_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DDLSOS.SelectedIndexChanged

    End Sub

    Protected Sub txtFurnace_inspection_TextChanged(sender As Object, e As EventArgs)
