				...
				<asp:Panel id="pnlSample" runat="server">
					<TABLE id="Table10" class="table">
						...
						<TR>
							...
							<TD >
								<asp:textbox id="txtCarbon" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD>
								<asp:textbox id="txtMn" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD>
								<asp:textbox id="txtSi" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD>
								<asp:textbox id="txtPhosph" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
						</TR>
						<TR>
							<TD>S</TD>
							<TD>Cr</TD>
						...
						<TR>
							<TD >
								<asp:textbox id="txtSulpher" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD >
								<asp:textbox id="txtCr" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD >
								<asp:textbox id="txtNi" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD >
								<asp:textbox id="txtCu" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD >
								<asp:textbox id="txtAl" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD>
								<asp:textbox id="txtMoly" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD>
								<asp:textbox id="txtVen" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD>
								<asp:textbox id="txtNitro" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
							<TD>
								<asp:textbox id="txtHydro" runat="server" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
						</TR>
						<TR>
							<TD vAlign="middle" align="center" colSpan="9">
