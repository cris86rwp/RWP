...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=18415&user0=crissqlserver&password0=cris-bela@1234567890" &
      "&prompt0=" & Trim(ddlLabNumber.SelectedItem.Text) & "&prompt1=" & 0 & ""
        strPathName &= "&user0@TestSampleResultsRemarks.rpt=crissqlserver&password0@TestSampleResultsRemarks.rpt=cris-bela@1234567890"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=18433&user0=crissqlserver&password0=cris-bela@1234567890&promptonrefresh=0& prompt0=" & Trim(rblDBRList.SelectedItem.Text) & "&prompt1=" & Val(TextBox1.Text) & ""
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=18439&user0=crissqlserver&password0=cris-bela@1234567890&promptonrefresh=0 &prompt0=''&prompt1=''"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Dim strServer, strPathName As String
        strServer = Server.MachineName
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=18544&user0=crissqlserver&password0=cris-bela@1234567890 &prompt0=" & Trim(rblSand.SelectedItem.Text) & "&prompt1='0'"
        Response.Redirect(strPathName)
    End Sub
