...
<!--/.Navbar -->
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" class="table">
				<TR>
					<TD noWrap colSpan="3"><FONT size="5">BHN Sample Wheel Heat Edit</FONT><hr class="prettyline" /></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD noWrap>:</TD>
					<TD noWrap><asp:label id="lblWh" runat="server"></asp:label>&nbsp;</TD>
				</TR>
				<TR>
					<TD noWrap>Present Heat Number</TD>
					<TD noWrap>:</TD>
					<TD noWrap><asp:label id="lblHt" runat="server"></asp:label>&nbsp;</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD noWrap>From Heat</TD>
					<TD noWrap>:</TD>
					<TD noWrap><asp:textbox id="txtFrHt" runat="server" CssClass="form-control"></asp:textbox></TD>
				</TR>
				<TR>
					<TD noWrap>To Heat</TD>
					<TD noWrap>:</TD>
					<TD noWrap><asp:textbox id="txtToHt" runat="server" CssClass="form-control"></asp:textbox></TD>
				</TR>
				<TR>
					<TD vAlign="top" noWrap align="middle" colSpan="3"><asp:button id="btnUpdate" runat="server" Text="Update" CssClass="button button2"></asp:button></TD>
				</TR>
			</TABLE>
                </div></div>
		</form>
