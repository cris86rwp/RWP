<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TestResult_StockWheels.aspx.vb" Inherits="WebApplication2.TestResult_StockWheels" Culture="en-GB" uiCulture="en-GB" %>
<!DOCTYPE html>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute" runat="server">
				<TABLE id="Table1" cellSpacing="1" cellPadding="1" border="1" class="auto-style1">
					<TR>
						<TD colSpan="3">Test Result Certificate</TD>
					</TR>
					<TR>
						<TD colSpan="3">
