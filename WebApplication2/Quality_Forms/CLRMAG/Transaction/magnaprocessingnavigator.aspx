    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="panel1" runat="server">
            <table class="table">
                ...
                <tr>
                    <td colspan="2"><asp:Button ID="btnsub" runat="server" Text="submit" CssClass="button button2"/></td>
                </tr>
            </table>
        </asp:Panel>
            ...
            <table class="table">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td> Machining Required</td>
                    <td><asp:TextBox ID="TxtmMchining" runat="server" CssClass="form-control"></asp:TextBox></td>
                     </asp:Panel>
                      <asp:Panel runat="server" ID="Panel5" >
                    <td>Grinding Required</td>
                    <td><asp:TextBox ID="TxtGrinding" runat="server" AutoPostBack="true" CssClass="form-control"></asp:TextBox></td>
                    </asp:Panel>
                      <asp:Panel runat="server" ID="Panel6" >
                    <td>XC Codes</td>
                    <td><asp:TextBox ID="TxtXCcodes" runat="server" AutoPostBack="true" CssClass="form-control"></asp:TextBox></td>
                    </asp:Panel>
                </tr>
                <tr>
                    <td>BHN</td>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtamm" runat="server" CssClass="form-control">107</asp:TextBox></td>
               
                     <td>BCF</td>
                    <td><asp:TextBox ID="txtbcf" runat="server" CssClass="form-control">0.2603</asp:TextBox></td>
                </tr>
                <tr>
                   <td>UT Batch No</td>
                ...
                <tr>
                    <td>HT Batch No</td>
                    <td><asp:TextBox ID="txthtbatch" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox></td>
                    <td aria-readonly="True">HT status</td>
        ...
        <asp:Panel ID="panel3" runat="server">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con %>" SelectCommand="select CONVERT(varchar, date,106) Date,shift Shift,copeinsp CopeID, draginsp DragID, linenumber Line,heatno HeatNO, wheelno WheelNo,bhn BHN, utbatch UTBatch, utwheelno UTWheelNo, utstatus UTStatus, utxcwhlsts UTWhlStatus, Machining, Grinding, XcCodes  from mm_magnaglow_shiftwiserecords_new where date=CONVERT(varchar, getdate(),23) "></asp:SqlDataSource>
        </asp:Panel>
