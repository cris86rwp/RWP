		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1"  runat="server">
				<TABLE id="Table2" class="table">
					<TR>
						<TD colSpan="6"><FONT size="5">Change Magna XC To MR XC</FONT><hr class="prettyline" /></TD>
					</TR>
					<TR>
						<TD colSpan="6">
					...
					<TR>
						...
						<TD>:</TD>
						<TD >
							<asp:Label id="lblPresent" runat="server"></asp:Label>&nbsp;</TD>
						<TD>ChangeTo</TD>
						<TD>:</TD>
						<TD>
							<asp:TextBox id="txtChange" runat="server" AutoPostBack="True" CssClass="form-control"></asp:TextBox>
							<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ControlToValidate="txtChange" ErrorMessage="*"></asp:RequiredFieldValidator></TD>
					</TR>
					<TR>
						<TD>Remarks</TD>
						<TD>:</TD>
				...
				<TABLE id="Table1" class="table">
					<TR>
						<TD>List of Wheels Changed Today :&nbsp; <hr class="prettyline" /></TD>
					</TR>
				</TABLE>
