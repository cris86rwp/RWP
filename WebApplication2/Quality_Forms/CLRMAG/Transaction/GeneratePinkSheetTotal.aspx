		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1"  runat="server" >
				<TABLE id="Table2" class="table">
					<TR>
						<TD vAlign="top" align="middle"><STRONG><FONT color="#0033ff" size="4">GENERATE PINK SHEET </FONT>
							</STRONG><hr class="prettyline" />
						</TD>
					</TR>
				</TABLE>
				...
				<TABLE id="Table4" class="table">
					<TR>
						...
						<TD colSpan="2">
							...
							<asp:CheckBox id="chkReGenerate" runat="server" TextAlign="Left" Text="Re-Generate?"></asp:CheckBox>&nbsp;</TD>
					</TR>
					<TR>
						<TD vAlign="top" align="middle" colSpan="3">
							<asp:Button id="btnGenerate" runat="server" Text="Generate" CssClass="button button2"></asp:Button></TD>
					</TR>
				</TABLE>
