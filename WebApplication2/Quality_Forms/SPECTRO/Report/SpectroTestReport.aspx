<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SpectroTestReport.aspx.vb" Inherits="WebApplication2.SpectroTestReport" Culture="en-GB" uiCulture="en-GB" %>
<!DOCTYPE html>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute" runat="server">
				<TABLE id="Table1" cellSpacing="1" cellPadding="1" border="1" class="auto-style1">
					<TR>
						<TD colSpan="3">Spectro Test Report Between Dates</TD>
					</TR>
					<TR>
						<TD colSpan="3">
