...
Public Class BHNchemicalvalueaddedit
    ...
    Public Function checkheat()
        ...
        Dim con As New SqlConnection("Data Source=192.168.0.125;Initial Catalog=wap;Persist Security Info=True;User ID=sa;Password=sa")
        con.Open()
    ...
    Public Function f1()
        ...
        Try
            con.ConnectionString = "Data Source=192.168.0.125;Initial Catalog=wap;Persist Security Info=True;User ID=sa;Password=sa"
            con.Open()
            cmd.Connection = con
