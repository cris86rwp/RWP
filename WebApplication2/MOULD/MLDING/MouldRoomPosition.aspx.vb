...
#End Region
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        '        strInsert = " insert into mm_MROutTurn ( OutTurnDate,Shift,txtDate,rblShift,ShiftInC,WhlsCast,MROffLoad,txtFr,txtTo,SWCQty,SWCInC,SWCRemarks,SGM1Qty,SGM1InC,SGM1Qty,SGM1InC,SGM1Remarks,SGM2Qty,SGM2InC,SGM2Remarks,SGM3Qty,SGM3InC,SGM3Remarks,SGM4Qty,SGM4InC,SGM4REmarks,SWPGQty,SWPGInC,SWPGRemarks,SWLess400,SWRecSts,HCM1Qty,HCM1InC,HCM1Remarks,HCM2Qty,HCM2InC,HCM2Remarks,HCM3Qty,HCM3InC,HCM3Remarks,HCLess250,HCRecSts,CBQty,CBInC,CBRemarks,C5IE,C5IW,C5KE,C5KW,CSQty,CSInC,CSRemarks,CSGr230,CSLess170,CSRecSts,DSQty,DSInC,DSRemarks,DSGr230,DSLess170,DSRecSts,COLQty,COLInC,COLRemarks,DOLQty,DOLInC,DOLRemarks,NBDQty,NBDInC,NBDRemarks,DDUQty,DDUInC,DDURemarks,CopesQty,CopesInC,CopesRemarks,DragsQty,DragsInC,DragsRemarks,CopesMQty,CopesMInC,CopesMRemarks,DragsMQty,DragsMInC,DragsMRemarks,SandQty,SandInC,SandRemarks,PTQty,PTInC,PTRemarks,MPO1,MPO2,MPO3) values ( @OutTurnDate,@Shift,@txtDate,@rblShift,@ShiftInC,@WhlsCast,@MROffLoad,@txtFr,@txtTo,@SWCQty,@SWCInC,@SWCRemarks,@SGM1Qty,@SGM1InC,@SGM1Remarks,@SGM2Qty,@SGM2InC,@SGM2Remarks,@SGM3Qty,@SGM3InC,@SGM3Remarks,@SGM4Qty,@SGM4InC,@SGM4REmarks,@SWPGQty,@SWPGInC,@SWPGRemarks,@SWLess400,@SWRecSts,@HCM1Qty,@HCM1InC,@HCM1Remarks,@HCM2Qty,@HCM2InC,@HCM2Remarks,@HCM3Qty,@HCM3InC,@HCM3Remarks,@HCLess250,@HCRecSts,@CBQty,@CBInC,@CBRemarks,@C5IE,@C5IW,@C5KE,@C5KW,@CSQty,@CSInC,@CSRemarks,@CSGr230,@CSLess170,@CSRecSts,@DSQty,@DSInC,@DSRemarks,@DSGr230,@DSLess170,@DSRecSts,@COLQty,@COLInC,@COLRemarks,@DOLQty,@DOLInC,@DOLRemarks,@NBDQty,@NBDInC,@NBDRemarks,@DDUQty,@DDUInC,@DDURemarks,@CopesQty,@CopesInC,@CopesRemarks,@DragsQty,@DragsInC,@DragsRemarks,@CopesMQty,@CopesMInC,@CopesMRemarks,@DragsMQty,@DragsMInC,@DragsMRemarks,@SandQty,@SandInC,@SandRemarks,@PTQty,@PTInC,@PTRemarks,@MPO1,@MPO2,@MPO3)  "

        '        strUpdate = " update mm_MROutTurn set OutTurnDate = @OutTurnDate and Shift = @Shift "
        ...
        Try
            ...
            Val(SandQty.Text), SandInC.Text & "", SandRemarks.Text & "",
             Val(PTQty.Text), PTInC.Text & "", PTRemarks.Text & "",
