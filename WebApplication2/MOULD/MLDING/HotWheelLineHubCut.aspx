hhh<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="HotWheelLineHubCut.aspx.vb" Inherits="WebApplication2.HotWheelLineHubCut" %>
   ...
   <form id="Form1" method="post" runat="server">
        ...
        <div class="table-responsive">
            <table  class="table"  id="table4">
                  <tr>
                   <td colspan="10" align="center" ><h3> HotWheelLine HubCut Details </h3> <hr class="prettyline" /></td>
                </tr>
                <tr>
                    <td >Date:</td>
                    <td >
                  ...
                  <%--  <td class="tooltiptext">--%>
                    ...
                    <td> Start time</td>
     <td> <asp:TextBox ID="TxtStart_Time" runat="server"  CssClass="form-control"  onblur="validateHhMm(this)" MaxLength="5"   placeholder="hh:mm" Text="00:00"></asp:TextBox></td><td><div id="result1"></div></td>
     <td> Finish time</td>
     <td> <asp:TextBox ID="TxtFinish_Time" runat="server" onblur="validateHhMm1(this)" MaxLength="5" CssClass="form-control"  placeholder="hh:mm" Text="00:00"></asp:TextBox></td><td><div id="result2"></div></td>
                    ...
                    <td>
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" display="Dynamic" ControlToValidate="TxtHheat_No"></asp:RequiredFieldValidator> Donot prefix zeroes</td>
                        ...
                        <td>
                         ...
                         <td><asp:DropDownList ID="DDLHStampStatus" runat="server" CssClass="form-control ll" AutoPostBack="True">
        ...
        <div class="table-responsive">
                <table id="table2" class="table" >
                     ...
                     <td> Heat No. </td>
                        ...
                        <td> Wheel No.</td>
                          <td> <asp:TextBox ID="TxtRWwheel_No" runat="server"  CssClass="form-control"></asp:TextBox></td>
                        ...
                        <td> Stamping Status</td>
                        <td><asp:DropDownList ID="DDLRWStampStatus" runat="server" CssClass="form-control ll">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>OK</asp:ListItem>
                            <asp:ListItem>Not OK</asp:ListItem>
			                <asp:ListItem>ByPass</asp:ListItem>
                        ...
                        <td>Status</td><td><asp:DropDownList ID="DDLRWStatus" runat="server" CssClass="form-control ll" AutoPostBack="true">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>OK</asp:ListItem>
                            <asp:ListItem>Not OK</asp:ListItem>
                            </asp:DropDownList></td>
                        ...
                        <td>XC/Offload Code</td>
                        <%--<asp:Panel runat="server" ID="Panel6" >--%>
                             <td><asp:DropDownList ID="DDLRWXcCode" runat="server" CssClass="form-control ll">
                            <asp:ListItem></asp:ListItem>
   <asp:ListItem>XC-3</asp:ListItem>
    <asp:ListItem>XC-10</asp:ListItem>
    <asp:ListItem>XC-13</asp:ListItem>
    ...
    <asp:ListItem>ByPass</asp:ListItem>
         ...
         <div class="table-responsive">
                <table id="table5" class="table" >
                        ...
                        <tr><td>Hub Cutting Nozzle replaced </td>
                        <td>
                            ...
                            <td>M/C No</td>
                            <td><asp:DropDownList ID="DDLNZRepMcNo" runat="server" CssClass="form-control ll" AutoPostBack="True">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>1</asp:ListItem>
                            <asp:ListItem>2</asp:ListItem>
                            <asp:ListItem>3</asp:ListItem>                          
                              ...
                              <td>Nozzale Type</td>
                              <td><asp:DropDownList ID="DDLNozzalType" runat="server" CssClass="form-control ll" AutoPostBack="True">
                               <asp:ListItem Value="AC">Air Cool</asp:ListItem>
                                 <asp:ListItem Value="WC">Water cool</asp:ListItem>
                                 </asp:DropDownList></td>
                        <td>Heat No</td>
                            <td><asp:TextBox ID="TxtHC_NZ_Heat_No" runat="server" CssClass="form-control" AutoPostBack="True" ></asp:TextBox></td>
                        <td>Wheel No</td>
       ...
       <table id="table3" class="table">
               <tr>
                       <td>Remarks:</td>
                        <td colspan="5">
                            <asp:TextBox ID="TxtHCRemarks" runat="server" CssClass="form-control" Width="141px"></asp:TextBox></td>
             </tr>
                <tr>
        ...
        <div class="table-responsive">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con %>" SelectCommand="select CONVERT(varchar, Date,105),HC_ProcesType,HeatNo,Wheel_No,HC_Temp,Stamping_Status,HC_Mcn_No,HC_Status,HC_XC_Code from  mm_HWLHubCutDetails where Date=CONVERT(varchar, getdate(),23) order by HC_ProcesType">
          </asp:SqlDataSource>
        </asp:Panel>
