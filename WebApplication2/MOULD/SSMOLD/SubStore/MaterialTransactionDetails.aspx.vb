...
Public Class MaterialTransactionDetails
    ...
    Protected Sub Button_Click(sender As Object, e As EventArgs) Handles Submit1.Click
        ...
        con.ConnectionString = "Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\lenovo\source\repos\WebApplication3\WebApplication3\App_Data\Database2.mdf;Integrated Security=True"
