     ...
     <div class="container">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute" runat="server">
				<TABLE id="Table1" style="WIDTH: 193px; HEIGHT: 80px" cellSpacing="1" cellPadding="1" width="193" border="1">
					<TR>
						<TD colSpan="3">Mould Room Formats</TD>
					</TR>
					<TR>
						<TD colSpan="3">
					...
					<TR>
						<TD align="middle" colSpan="3">
							<asp:RadioButtonList id="rblType" runat="server" Width="242px" RepeatLayout="Flow" Height="229px">
					...
					<TR>
						<TD align="middle" colSpan="400">
							<asp:Button id="btnShow" runat="server" Text="Show Report" CssClass="auto-style1" Height="51px" Width="205px"></asp:Button></TD>
					</TR>
				</TABLE>
