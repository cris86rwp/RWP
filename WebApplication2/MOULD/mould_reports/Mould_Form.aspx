<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MouldNewReports.aspx.vb" Inherits="WebApplication2.MouldNewReports" Culture="en-GB" uiCulture="en-GB" %>
<!DOCTYPE html>
			...
			<asp:panel id="Panel1" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute" runat="server">
				<TABLE id="Table1" cellSpacing="1" cellPadding="1" border="1" class="auto-style1">
                   ...
                   <%-- <TR>
                    ...
                    <TR>
                        <TD align="middle" colSpan="3">Casting Details</TD>
                        <TD colSpan="3">
						<TD>FromDate</TD>
						<TD colSpan="3">
