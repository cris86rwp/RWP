<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CriticalStockItemListEdit.aspx.vb" Inherits="WebApplication2.CriticalStockItemListEdit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>CriticalStockItemListEdit</title>
						...
						<TABLE id="Table1" class="table">
							<TR>
								<TD colSpan="6"><FONT size="5">
										...
										List - Stock</FONT>&nbsp; <FONT color="#000000">( EDIT )</FONT>
								</TD>
							</TR>
							<TR>
