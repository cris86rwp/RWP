<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CriticalNonStockItemListDelete.aspx.vb" Inherits="WebApplication2.CriticalNonStockItemListDelete" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>CriticalNonStockItemListDelete</title>
					...
					<TD>
						<TABLE id="Table3" class="table">
							...
							<TR>
								<TD>Remarks</TD>
								<TD>:</TD>
								<TD colSpan="7"><asp:textbox id="txtRemarks" CssClass="form-control" runat="server"></asp:textbox></TD>
							</TR>
							<TR>
								<TD vAlign="top" align="middle" colSpan="9"><asp:button id="btnSave" runat="server" Text="Delete" CssClass="button button2"></asp:button>
									<asp:Label id="lblRecID" runat="server" Visible="False"></asp:Label></TD>
							</TR>
						</TABLE>
						<asp:datagrid id="dgSavedData" runat="server" GridLines="Vertical" CellPadding="3" BackColor="White" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" Font-Size="Smaller" CssClass="Table">
