<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CriticalNonStockItemListEdit.aspx.vb" Inherits="WebApplication2.CriticalNonStockItemListEdit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>CriticalNonStockItemListEdit</title>
...
<div class="table-responsive">
			...
			<TABLE id="Table2" class="table">
						...
						<TABLE id="Table1" class="table">
							<TR>
								<TD colSpan="6"><FONT size="5">
										...
										List - Non Stock</FONT>&nbsp; <FONT color="#000000">( EDIT )</FONT>
								</TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD>Sl No</TD>
								<TD>:</TD>
								<TD><asp:textbox id="txtSlNo" runat="server" CssClass="form-control" AutoPostBack="True"></asp:textbox></TD>
							</TR>
							<TR>
								<TD>Pl Desc</TD>
								<TD>:</TD>
						...
						<TABLE id="Table3" class="table">
							...
							<TR>
								<TD vAlign="top" align="middle" colSpan="9"><asp:button id="btnSave" runat="server" Text="Save" CssClass="button button2"></asp:button><asp:label id="lblRecID" runat="server" Visible="False"></asp:label></TD>
							</TR>
						</TABLE>
						<asp:datagrid id="dgSavedData" runat="server" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="3" GridLines="Vertical" Font-Size="Smaller" CssClass="Table">
