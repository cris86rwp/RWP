<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CriticalStockItemListUndoDelete.aspx.vb" Inherits="WebApplication2.CriticalStockItemListUndoDelete" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>CriticalStockItemListUndoDelete</title>
...
<div class="table-responsive">
			...
			<TABLE id="Table2" class="table">
						...
						<TABLE id="Table3" class="table">
							...
							<TR>
								<TD vAlign="top" align="middle" colSpan="9"><asp:button id="btnSave" runat="server" CssClass="button button2" Text="Undo Delete"></asp:button>
						...
						<asp:datagrid id="dgSavedData" runat="server" GridLines="Vertical" CellPadding="3" BackColor="White" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" Font-Size="Smaller" CssClass="Table">
							...
							<Columns>
								<asp:ButtonColumn Text="Undo Delete" CommandName="Delete"></asp:ButtonColumn>
							</Columns>
