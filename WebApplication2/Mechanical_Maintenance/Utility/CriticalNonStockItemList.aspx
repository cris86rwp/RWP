<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CriticalNonStockItemList.aspx.vb" Inherits="WebApplication2.CriticalNonStockItemList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>CriticalNonStockItemList</title>
...
<div class="table-responsive">
			...
			<TABLE id="Table2" class="table">
						...
						<TABLE id="Table3" class="table">
							...
							<TR>
								<TD vAlign="top" align="middle" colSpan="9"><asp:button id="btnSave" runat="server" Text="Save" CssClass="button button2"></asp:button><asp:label id="lblType" runat="server"></asp:label></TD>
							</TR>
							<TR>
								<TD vAlign="top" align="left" colSpan="9">Saved&nbsp; Data for report :</TD>
							</TR>
						</TABLE>
						<asp:datagrid id="dgSavedData" runat="server" CellPadding="4" BackColor="White" BorderWidth="1px" BorderStyle="None" BorderColor="#CC9966" Font-Size="Smaller" CssClass="Table">
