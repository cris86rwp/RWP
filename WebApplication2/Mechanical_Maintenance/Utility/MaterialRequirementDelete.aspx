<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MaterialRequirementDelete.aspx.vb" Inherits="WebApplication2.MaterialRequirementDelete" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>MaterialRequirementDelete</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table2" class="table">
				<TR>
					<TD>
						<TR>
								<TD colSpan="6"><FONT size="5"> &nbsp;Material Requirement for Annual 
										Shut-down&nbsp;-&nbsp;Delete&nbsp;-&nbsp;</FONT>&nbsp;
