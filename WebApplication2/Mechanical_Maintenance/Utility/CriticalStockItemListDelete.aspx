...
<div class="table-responsive">
			...
			<TABLE id="Table2" class="table">
						...
						<TABLE id="Table3" class="table">
							...
							<TR>
								<TD vAlign="top" align="middle" colSpan="9"><asp:button id="btnSave" runat="server" Text="Delete" CssClass="button button2"></asp:button><asp:label id="lblRecID" runat="server" Visible="False"></asp:label></TD>
							</TR>
						</TABLE>
