Public Class CriticalStockItemList
...
#End Region
    ...
    Private Sub txtPlNumber_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPlNumber.TextChanged
        ...
        Dim ds As New DataSet()
        Try
            ds = CriticalItems.ItemTables.StockDetails(txtPlNumber.Text, lblConsignee.Text)
            ...
            lblLastIssueDate.Text = IIf(IsDBNull(ds.Tables(0).Rows(0).Item(5)), "1900-01-01", ds.Tables(0).Rows(0).Item(5))
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            Try
                ...
                SaveList.LastIssueDate = CDate(lblLastIssueDate.Text.Trim)
                SaveList.Equip = txtEquip.Text.Trim & ""
                SaveList.Type = lblType.Text.Trim
                SaveList.PO = txtNum.Text
                SaveList.PODt = IIf(IsDBNull(txtDt.Text.Trim), "1900-01-01", Format(CDate(txtDt.Text.Trim.Replace("&nbsp;", "1900-01-01")), "yyyy-MM-dd"))
                SaveList.POQty = IIf(IsDBNull(txtQty.Text), 0, txtQty.Text.Replace("&nbsp;", "0"))
                SaveList.PODD = IIf(IsDBNull(txtDD.Text.Trim), "", txtDD.Text.Trim.Replace("&nbsp;", "1900-01-01"))
                SaveList.POSup = txtSup.Text.Trim.Replace("&nbsp;", "")
