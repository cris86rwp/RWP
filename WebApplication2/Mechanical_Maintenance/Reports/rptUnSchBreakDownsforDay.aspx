<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rptUnSchBreakDownsforDay.aspx.vb" Inherits="WebApplication2.rptUnSchBreakDownsforDay" Culture="en-GB" uiCulture="en-GB" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>DueForCalibration</title>
...
<!--/.Navbar -->
		...
		<form id="Form1" method="post" runat="server">
           <div class="row">
			...
			<TABLE id="Table1" class="table">
				<TR>
					<TD colSpan="4" align="middle"><FONT face="Arial" size="4"><FONT face="Arial" size="4">Unschedule 
								Works&nbsp;</FONT></FONT></TD>
				</TR>
				<TR>
					<TD colSpan="4">
						<asp:Label id="lblErr" runat="server" Font-Names="Arial" Font-Bold="True" ForeColor="Red" Font-Size="Smaller"></asp:Label></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colSpan="2">
						<asp:Button id="btnShow" runat="server" Font-Names="Arial" CssClass="button button2" Text="DateWise Report"></asp:Button></TD>
					<TD></TD>
					<TD>
				...
				<TR>
					...
					<TD>:</TD>
					<TD>
						<asp:ListBox id="lstMachineCode" runat="server" SelectionMode="Multiple" CssClass="ll"></asp:ListBox></TD>
				</TR>
				<TR>
					<TD vAlign="top" align="middle" colSpan="4">
						<asp:Button id="btnSelected" runat="server" Text="Show Selected Machines Report" CssClass="button button2"></asp:Button></TD>
				</TR>
			</TABLE>
		</asp:panel>
