...
#End Region
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        Else
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=18344&user0=crissqlserver&password0=cris-bela@1234567890"
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Else
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=18364&user0=crissqlserver&password0=cris-bela@1234567890"
            strPathName &= "&prompt0=" & lblGrp.Text.Trim & ""
            strPathName &= "&prompt1= DateTime(" & CStr(CDate(dt).Year) & "," & CStr(CDate(dt).Month) & "," & CStr(CDate(dt).Day) & ", 0,0,0)"
            strPathName &= "&prompt2= DateTime(" & CStr(CDate(dt1).Year) & "," & CStr(CDate(dt1).Month) & "," & CStr(CDate(dt1).Day) & ", 0,0,0)"
            Response.Redirect(strPathName)
