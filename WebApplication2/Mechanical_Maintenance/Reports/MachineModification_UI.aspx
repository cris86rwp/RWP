<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MachineModification_UI.aspx.vb" Inherits="WebApplication2.MachineModification_UI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>MachineModification_UI</title>
...
<TABLE id="Table1" class="table">
					<TR>
						<TD align="middle" colSpan="4">Machine Modification Reports</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD align="middle" colSpan="4">Shop :
					...
					<TR>
						<TD align="middle" colSpan="4">Machine :&nbsp;&nbsp;
							<asp:DropDownList id="cboMachineCode" runat="server" CssClass="form-control"></asp:DropDownList></TD>
					</TR>
					<TR>
