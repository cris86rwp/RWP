Public Class PreventiveMaintenanceadd
...
#End Region
        ...
        If Not Page.IsPostBack Then
            Try
                ...
                ElseIf lblMode.Text = "edit" Then
                    ...
                    txtpl_qty.Text = 0
                End If
                PopulatePMLocation(lblMode.Text.Trim, lblMGroup.Text)
    ...
    Private Sub PopulatePMLocation(ByVal mode As String, ByVal group As String)
        lblMessage.Text = ""
        lblMessage1.Text = ""
        Dim ds As DataSet
        Try
            ds = Maintenance.tables.PMLocation(mode, group, "P")
    ...
    Private Sub PopulateMachineCode(ByVal mode As String, ByVal shopcode As String, ByVal Group As String)
        ...
        Dim dt As DataTable
        Try
            dt = Maintenance.tables.PMSchMachineCode(mode, shopcode, CDate(txtDate.Text), lblGroup.Text.Trim)
    ...
    Private Sub cboMachine_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboMachine.SelectedIndexChanged
        ...
        If lblMode.Text = "edit" Then
            ...
            Else
                ...
                Dim i As Integer
                Try
                    dt = Maintenance.tables.GetPMSchDetails(lblMGroup.Text, cboWorkOrderNo.SelectedItem.Text, CDate(txtDate.Text))
    ...
    Private Sub PopulateSubAssembly()
        ...
        Try
            dt = Maintenance.tables.GetPMSchSubAssemblyList(lblMode.Text, cboMachine.SelectedItem.Value, grp, ddlShopCode.SelectedItem.Value)
    ...
    Public Sub PopulateWorkOrders()
        ...
        cboWorkOrderNo.Items.Clear()
        dt = Maintenance.tables.PMSchWorkorders(lblMGroup.Text.Trim, CDate(txtDate.Text), ddlShopCode.SelectedItem.Value.Trim)
    ...
    Private Sub cboWorkOrderNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboWorkOrderNo.SelectedIndexChanged
        ...
        Else
            ...
            Try
                ...
                dtSpares = Maintenance.tables.WOSpares("P", cboWorkOrderNo.SelectedItem.Text.Trim, lblMGroup.Text.Trim)
                cboSpares.DataSource = dtSpares
                cboSpares.DataTextField = dtSpares.Columns("pl_desc").ColumnName
                cboSpares.DataValueField = dtSpares.Columns("pl_number").ColumnName
                cboSpares.DataBind()
    ...
    Private Sub cboSpares_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboSpares.SelectedIndexChanged
        ...
        Else
            ...
            Try
                ...
                End If
                If lblMode.Text.Equals("edit") Then
                    dt = Maintenance.tables.WOSpares("P", cboWorkOrderNo.SelectedItem.Value, lblMGroup.Text, cboSpares.SelectedItem.Value)
