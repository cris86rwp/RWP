<%@ Page Language="vb" AutoEventWireup="false" Codebehind="unScheduleEntryEdit.aspx.vb" Inherits="WebApplication2.unScheduleEntryEdit" Culture="en-GB" uiCulture="en-GB" %>
<!DOCTYPE html PUBLIC "-//W3C//Dtd html 4.0 transitional//EN">
<html>
<head runat="server">
    <title>unScheduleEntryEdit</title>
                ...
                <div class="table-responsive">
                    ...
                    <asp:Panel id="Panel1" runat="server">
                        <table id="table2" class="table">
                            <tr>
                                <td align="middle">
                                    Condition Based&nbsp;Maintenance Entry
                                    <asp:label id="lblGroup" runat="server" Visible="False"></asp:label>
                                </td>
                                <td align="right">
                                    Mode :
                                    <asp:label id="lblMode" runat="server" ForeColor="Red"></asp:label>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table id="table3" class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:dropdownlist id="cboWorkOrderNo" runat="server" CssClass="form-control ll" AutoPostBack="true"></asp:dropdownlist>
                                </td>
                            </tr>
                        </table>
                        <table id="table4" class="table">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:dropdownlist id="cboMachine" runat="server" CssClass="form-control ll" AutoPostBack="true"></asp:dropdownlist>
                                </td>
                            </tr>
                            <tr>
                                <td>SubAssembly</td>
                                <td>:</td>
                                <td>
                                    <asp:dropdownlist id="cboAssembly" runat="server" CssClass="form-control ll" AutoPostBack="true"></asp:dropdownlist>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table id="table6" class="table">
                            <tr>
                                ...
                                <td>
                                    <asp:textbox id="txtFrom" runat="server" CssClass="form-control" AutoPostBack="true"></asp:textbox>
                                </td>
                                <td>
                        ...
                        <table id="table7" class="table">
                            <tr>
                                ...
                                <td>
                                    <asp:textbox id="txtTo" runat="server" CssClass="form-control" AutoPostBack="true"></asp:textbox>
                                </td>
                                <td>
                                    <asp:textbox id="txtTo_time" runat="server" CssClass="form-control"></asp:textbox>
                                </td>
                                <td>
                                    <P>(DD/MM/YYY HH:MM)</P>
                                </td>
                        ...
                        <table id="table8" class="table">
                            <tr>
                                ...
                                <td>
                                    <asp:textbox id="txtWork_done" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:textbox>
                                </td>
                            </tr>
                        </table>
                        <table id="table9" class="table">
                            <tr>
                                <td>AttendedBy</td>
                                <td>
                                    <asp:textbox id="txtAttendent" runat="server" CssClass="form-control"></asp:textbox>
                                </td>
                                <td>( PFNo.s)</td>
                                <td>Supervisor</td>
                                <td>
                        ...
                        <table id="table13" class="table">
                            <tr>
                                ...
                                <td>
                                    <P>
                                        <asp:dropdownlist id="cboSpares" runat="server" AutoPostBack="true" CssClass="form-control ll"></asp:dropdownlist>
                                    </P>
                                </td>
                            </tr>
                        </table>
                        <table id="table1" class="table">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:textbox id="txtPLNumber" runat="server" CssClass="form-control"></asp:textbox>
                                </td>
                                <td>Quantity</td>
                                <td>:</td>
                                <td>
                                    <asp:textbox id="txtpl_qty" runat="server" CssClass="form-control" AutoPostBack="true"></asp:textbox>
                                </td>
                            </tr>
                            <tr>
                                <td>SpareType</td>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:textbox id="txtSpareCost" runat="server" CssClass="form-control"></asp:textbox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <table id="table11" class="table">
                            <tr>
                                <td>
                                    <asp:button id="btnSave" runat="server" CssClass="button button2" Text="Save" BorderStyle="Groove"></asp:button>
                                </td>
                                <td>
                                    <asp:button id="btnClear" runat="server" CssClass="button button2" Text="Clear" BorderStyle="Groove"></asp:button>
                                </td>
                                <td>
                                    <asp:button id="btnExit" runat="server" CssClass="button button2" Text="Exit" BorderStyle="Groove"></asp:button>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>&nbsp;
