       ...
       <%-- <form id="Form1" method="post" runat="server">--%>
			<asp:Panel id="Panel1" runat="server">
				<TABLE id="Table2" class="table">
					<TR>
						<TD align="middle">Preventive&nbsp;Maintenance Entry Schedule
				...
				<TR>
                    ...
                    <TD  class="auto-style42">
								 <asp:RadioButtonList ID="shopCode" runat="server" AutoPostBack="True" CSSClass="rbl" RepeatDirection="horizontal" RepeatLayout="Flow">
				...
				<TABLE id="Table12" class="table">
                    ...
                    <TR>
						<TD style="HEIGHT: 21px" align="middle" colSpan="3">
				...
				<TABLE id="Table11" class="table">
					<TR>
						...
						<TD>
							<asp:button id="btnClear" runat="server" CssClass="button button2" Text="Reset" BorderStyle="Groove"></asp:button></TD>
							</TR>
				</TABLE>
			</asp:Panel>&nbsp;</form>
