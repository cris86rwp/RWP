    ...
    Public Class Melting
        Public Shared Function GetPFremarks(ByVal YearMonth As String, ByVal PFNo As String) As String
            ...
            Try
                ...
                oCmd.CommandText = "select @PFRemarks = PFRemarks from mm_vw_MeltPCDO where YearMonth = @YearMonth " & _
                        " and PFNo = @PFNo "
                oCmd.ExecuteScalar()
        ...
        Public Shared Function GetMeltPCDODetails(ByVal YearMonth As String) As DataTable
            ...
            Try
                da.SelectCommand.CommandText = " select Accidents , DAR , OT , PFNo , EmployeeName , Designation ,  " & _
        ...
        Public Shared Function GetPFDetails(ByVal PFNo As String) As DataTable
            ...
            Dim da As SqlClient.SqlDataAdapter = rwfGen.Connection.Adapter
            Try
                da.SelectCommand.CommandText = " select employee_name EmployeeName, short_description Designation " & _
                    " from hr_employee_master c inner join hr_designation_master d on c.designation_code = d.designation_code " & _
        ...
        Public Shared Function GetFumeExtractionDetails() As DataTable
            ...
            Dim da As SqlClient.SqlDataAdapter = rwfGen.Connection.Adapter
            Try
                da.SelectCommand.CommandText = " select top 5 FromHeat , ToHeat , " & _
                    " convert(varchar(10),OffTime,103) OffDate , convert(varchar(5),OffTime,108) OffTime ,  " & _
                    " convert(varchar(10),OnTime,103) OnDate , convert(varchar(5),OnTime,108) OnTime ,  Remarks , SlNo " & _
        ...
        Public Shared Function GetPreHeatedLadleSetTemp(ByVal PreHeatID As Integer) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select PreHeatID , convert(varchar(10),SetDateTime,103) SetDate  ," & _
                    " convert(varchar(5),SetDateTime,108) SetTime , LPH , HSDQty , SetTemp , ActualTemp , Staff , Remarks , SetID " & _
        ...
        Public Shared Function GetLiningDetails(ByVal LiningNo As String) As DataTable
            ...
            Dim da As SqlClient.SqlDataAdapter = rwfGen.Connection.Adapter
            Try
                da.SelectCommand.CommandText = "select LadleNo , convert(varchar(10),StartTime,103) StartDate  ," & _
                    " convert(varchar(5),StartTime,108) StTime , case when Type = '0' then 'New' else 'ReHeat' end Type , " & _
                    " LiftingTemp , FromHeat , ToHeat , Remarks  " & _
        ...
        Public Shared Function GetPreHeatIDs() As DataTable
            ...
            Dim da As SqlClient.SqlDataAdapter = rwfGen.Connection.Adapter
            Try
                da.SelectCommand.CommandText = "select LiningNo , LadleNo , convert(varchar(10),StartTime,103) StartDate  ," & _
                    " convert(varchar(5),StartTime,108) StTime , case when Type = '0' then 'New' else 'ReHeat' end Type , " & _
        ...
        Public Shared Function GetLiningNoDetails(ByVal LiningNo As String) As DataTable
            ...
            Try
                da.SelectCommand.Parameters.Add("@LiningNo", SqlDbType.VarChar, 50).Value = LiningNo
                da.SelectCommand.CommandText = "select LiningItemNo LadleNo ," & _
                    " convert(varchar(10),HandedOverOn,103) HandedOverDt , convert(varchar(5),HandedOverOn,114) HOTime , " & _
                    " convert(varchar(10),WorkStartedOn,103) WorkSartDt , convert(varchar(5),WorkStartedOn,114) WSTime , " & _
                    " convert(varchar(10),WorkCompletedOn,103) WorkCompDt , convert(varchar(5),WorkCompletedOn,114) WCTime " & _
        ...
        Public Shared Function GetPreHeatedLadleDetails(ByVal LiningNo As String) As DataTable
            ...
            Try
                da.SelectCommand.Parameters.Add("@LiningNo", SqlDbType.VarChar, 50).Value = LiningNo
                da.SelectCommand.CommandText = "select LiningNo , LadleNo , convert(varchar(10),StartTime,103) StartDate  ," & _
                    " convert(varchar(5),StartTime,108) StTime , convert(varchar(10),EndTime,103) EndDate , " & _
                    " convert(varchar(5),EndTime,108) EndTime , wap.dbo.ms_fn_ConvertTimeInNumberToHour(datediff(mi,StartTime,EndTime)) TotTime ,     " & _
                    " LiftingTemp , FromHeat , ToHeat , StaffNo , case when Type = '0' then 'New' else 'ReHeat' end Type , Remarks , PreHeatID " & _
                    " from mm_PreHeatedLadleDetails where LiningNo = @LiningNo " & _
                    " order by StartTime "
                da.Fill(ds)
                Return ds.Tables(0)
            Catch exp As Exception
        ...
        Public Shared Function GetFurnaceLife(ByVal FurNo As String) As String
            ...
            Try
                ...
                oCmd.CommandText = "select top 1 @Life = isnull(furnace_life,0) from mm_vw_HeatTapped a inner join mm_furnace_condition b" & _
                    " on a.heat_number = b.heat_number and heat_tapped >=  ( " & _
                    " select top 1 WorkCompletedOn from ms_FurnaceLining" & _
                    " where lt = 2 and LiningItemNo = @FurNo " & _
                    " order by WorkCompletedOn desc )" & _
        ...
        Public Shared Function GetRoofLiningNo(ByVal RoofNo As String, ByVal HeatNo As Long) As String
            ...
            Try
                ...
                oCmd.CommandText = "select top 1 @LiningNo = LiningNo from ms_furnacelining" & _
                    " where lt = 4 and liningItemNo = @RoofNo " & _
                    " and WorkCompletedOn < ( select heat_tapped from mm_vw_HeatTapped" & _
                    " where heat_number = @HeatNo )" & _
        ...
        Public Shared Function GetRoofLife(ByVal RoofNo As String) As String
            ...
            Try
                ...
                oCmd.Parameters.Add("@RoofNo", SqlDbType.VarChar, 10).Value = RoofNo
                oCmd.Parameters.Add("@Life", SqlDbType.Int, 4).Direction = ParameterDirection.Output
                oCmd.CommandText = "select top 1 @Life = Life from mm_roof_details " & _
                    " where roof_number = @RoofNo " & _
        ...
        Public Shared Function GetRoofNo(ByVal FurNo As String, ByVal FromHeatNo As Long) As String
            ...
            Try
                ...
                oCmd.CommandText = "select top 1 @RoofNo = RoofNo from mm_RoofFixing " & _
                    " where FurnaceCode = @FurnaceCode and ToHeatNo = 0 and @FromHeatNo >= FromHeatNo " & _
        ...
        Public Shared Function RoofFixingList(ByVal RoofNo As String) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select top 5 RoofNo , FurnaceCode Fur , " & _
                    " FromHeatNo , ToHeatNo , Reason , Remarks , LiningNo from mm_RoofFixing " & _
                    " where RoofNo = @RoofNo " & _
                    " order by FromHeatNo desc "
                da.Fill(ds)
                Return ds.Tables(0)
            Catch exp As Exception
        ...
        Public Shared Function ContractDetails(ByVal ContractNo As String) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = " select  convert(varchar(10),a.contract_date,103) ContractDt  ,  " & _
                    " a.contract_number ContractNo , Qty , (rtrim(a.agrement_number)) AgrementNumber ,  " & _
                    " rtrim((isnull(a.contractor_name,''))) ContractorName , ltrim((rtrim(a.work_name))) WorkName " & _
                    " from fm_contract a  inner join code b on  a.consignee = b.code and b.application = 'PM' and b.code_type = 'CC'  " & _
                    " inner join fm_code c on a.department_code = c.code and c.code_type = 'CC' AND LEFT(RTRIM(C.CODE),1) NOT IN ('B','R','O','W')  " & _
                    " left outer join mm_ContractQty e on ContractNo = a.contract_number " & _
                    " left outer join fm_vw_Contract_Total_Payment d on a.department_code = d.department_code " & _
                    " and a.contract_number = d.contract_number " & _
                    " where a.consignee = 'PTMS' and a.department_code = 'HH'" & _
        ...
        Public Shared Function LadlePOSavedDetails(ByVal PONumber As String) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select InspCertificateNo CerNo , " & _
                    " convert(varchar(10),InspCertificateDate,103) CerDate, AcceptedQty , " & _
                    " BricksSize , PLC, RUL, PCE, AP, Remarks " & _
        ...
        Public Shared Function LadlePODetails(ByVal PONumber As String) As DataTable
            ...
            Try
                da.SelectCommand.Parameters.Add("@PONumber", SqlDbType.VarChar, 50).Value = PONumber
                da.SelectCommand.CommandText = "select po_date , order_quantity , received_quantity , " & _
                    " rtrim(c.UnitName) UnitName , po_alternate_description , d.name Firm" & _
                    " from pm_po_header a inner join pm_po_details b on a.po_number = b.po_number " & _
                    " inner join pm_ItemMaster c on c.pl_number = b.pl_number " & _
                    " inner join pm_SupplierMaster d on d.supplier_code = a.supplier_code " & _
        ...
        Public Shared Function CheckPreviousHeatTapTime(ByVal heat_number As Long, ByVal heat_tapped As Date) As String
            ...
            Try
                ...
                oCmd.CommandText = "select @PreHeatTapped = heat_number from mm_offheat_heatsheet_header " & _
                    " where heat_number = @PreHeatNumber"
                oCmd.ExecuteScalar()

                If IsDBNull(oCmd.Parameters("@PreHeatTapped").Value) Then
                    oCmd.CommandText = "select @PreHeatTapped = heat_tapped from " & _
        ...
        Public Shared Function IsMeltDateOfPreviousHeatGreater(ByVal PreviousHt As Long, ByVal MeltDate As Date) As Boolean
            ...
            Try
                If oCmd.Connection.State = ConnectionState.Closed Then oCmd.Connection.Open()
                oCmd.CommandText = "select @melt_date = melt_date  " & _
        ...
        Public Shared Function CheckPHLDateForHeatNo(ByVal heat_number As Long) As Boolean
            ...
            Try
                If oCmd.Connection.State = ConnectionState.Closed Then oCmd.Connection.Open()
                oCmd.CommandText = "select @cnt = count(*) from " & _
                    " mm_heatsheet_header a inner join mm_vw_HeatTapped b" & _
                    " on a.heat_number = b.heat_number inner join " & _
                    " mm_phl_generation  c on phl_Date = TappedDate " & _
        ...
        Public Shared Function GetSampleData(ByVal heat_number As Long, Optional ByVal Sample As String = "") As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select sample_number SmpNo  , " & _
                    " rtrim(sample_taken_time) SmpTime ,  sample_temperature SmpTemp , " & _
                    " car_car C , man_man Mn ,  sil_sil Si , pho_pho P , sul_sul S , chr_chr Cr , ni_ni N , " & _
                    " cop_cop Cu , alu_alu Al ,  moly_moly Mo , Ven_Ven V , nitro_nitro Ni , hydro_hydro H " & _
        ...
        Public Shared Function GetSheet2Data(ByVal heat_number As Long) As DataSet
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select furnace_inspection ," &
                    ...
                    " charge_met , t6_power , t2_power ,t4_power , t8_power , " &
                    " t10_power ,t12_power from mm_heat_sheet_melting " &
        ...
        Public Shared Function GetContractDetails(ByVal ContractNo As String) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select convert(varchar(10), contract_date,103) ContractDt , " & _
                    " (rtrim(agrement_number)) AgrementNumber , rtrim((isnull(contractor_name,''))) ContractorName , " & _
                    " convert(decimal(9,3),Qty) LOAQty , UsedQty = ( select  convert(decimal(9,3),sum(rsm_contract)) " & _
                    " from mm_inprocess_additives a inner join mm_vw_HeatTapped b on a.heat_number = b.heat_number " & _
                    " where ContractNo = @ContractNo ) , Balance = convert(decimal(9,3), " & _
                    " ( Qty - ( select convert(decimal(9,3),sum(rsm_contract)) from mm_inprocess_additives " & _
                    " a inner join mm_vw_HeatTapped b on a.heat_number = b.heat_number " & _
                    " where ContractNo = @ContractNo) )) from fm_contract inner join mm_ContractQty b " & _
                    " on contract_number = ContractNo where consignee = 'PTMS' and department_code = 'HH' " & _
        ...
        Public Shared Function GetSheet1ElectrodeDetails(ByVal heat_number As Long) As DataTable
            ...
            Try
                da.SelectCommand.Parameters.Add("@Heat", SqlDbType.BigInt, 8).Value = heat_number
                da.SelectCommand.CommandText = " select e1Reason , e2Reason , e3Reason , " & _
                    " e1Time , e2Time, e3Time, e1remark, e2remark, e3remark ,  " & _
                    " Location1 , Location2 , Location3 " & _
        ...
        Public Shared Function PreviousLadleDetails(ByVal heat_number As Long, ByVal ladle_number As String) As DataTable
            ...
            Dim ds As New DataSet()
            Try
                da.SelectCommand.CommandText = " select top 1 life , heat_number from mm_ladle_details " & _
        ...
        Public Shared Function GetMakes() As DataSet
            ...
            Dim da As SqlClient.SqlDataAdapter = rwfGen.Connection.Adapter
            Try
                da.SelectCommand.CommandText = "select TipMake from mm_vw_TipMake order by TipMake ; " & _
                    " select LPipeMake from mm_vw_LancingPipeMake order by LPipeMake desc ; " & _
                    " select DRMMake from mm_vw_DRMMake order by DRMMake ; " & _
                    " select WRMMake from mm_vw_WRMMake order by WRMMake ; " & _
        ...
        Public Shared Function GetWoNo(ByVal MeltDate As Date) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select RTRIM(number+'-'+description) as wonumber , number " & _
                    " from mm_workorder where shop_code like 'E%' and status like 'O%' " & _
        ...
        Public Shared Function CheckOffHeatNo(ByVal HeatNo As Long) As Boolean
            ...
            Try
                If oCmd.Connection.State = ConnectionState.Closed Then oCmd.Connection.Open()
                oCmd.CommandText = "select @cnt = count(*) from mm_offheat_heatsheet_header " & _
        ...
        Public Function LadleWeights(ByVal Heat As Long, ByVal w1 As Double, ByVal w2 As Double) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    CheckHeat = IIf(IsDBNull(oCmd.Parameters("@cnt").Value), 0, oCmd.Parameters("@cnt").Value)
                    If CheckHeat = 0 Then
                        oCmd.CommandText = "insert into mm_ladleweights ( heat_number,w1,w2 ) " & _
                             " values ( @Heat , @w1 , @w2 )"
                    Else
            ...
            Return Done
        End Function
        Public Function SaveHeatSheet(ByVal Heat As Long, ByVal furnace_code As String, ByVal melt_date As Date, ByVal shift_code As String, ByVal shift_incharge As String, ByVal furnace_incharge As String, ByVal workorder_number As String) As Boolean
            Dim Done As Boolean
            Dim oCmd As SqlClient.SqlCommand = rwfGen.Connection.CmdObj
            If oCmd.Connection.State = ConnectionState.Closed Then oCmd.Connection.Open()
            Try
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_heatsheet_header set furnace_code = @furnace_code , melt_date = @melt_date , " & _
                       " shift_code = @shift_code , shift_incharge = @shift_incharge , furnace_incharge = @furnace_incharge ," & _
                       " workorder_number = @workorder_number where heat_number = @heat_number " '
                Else
                    oCmd.CommandText = "insert into mm_heatsheet_header ( heat_number , furnace_code , " & _
                        " melt_date , shift_code , shift_incharge , furnace_incharge , workorder_number ) " & _
                        " values ( @heat_number , @furnace_code , " & _
                        " @melt_date , @shift_code , @shift_incharge , @furnace_incharge , @workorder_number ) "
                End If
                oCmd.Transaction = oCmd.Connection.BeginTransaction
        ...
        Public Function SaveRoof(ByVal heat_number As Long, ByVal roof_number As String, ByVal life As Integer, ByVal delta As String, ByVal roof_outer As String) As Boolean
            ...
            Try
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_roof_details set roof_number = @roof_number , life = @life , " & _
                        " delta = @delta , roof_outer = @roof_outer where heat_number = @heat_number "
                Else
                    oCmd.CommandText = "insert into mm_roof_details ( heat_number ,  " & _
                        " roof_number , life , delta , roof_outer ) " & _
                        " values ( @heat_number , @roof_number , " & _
        ...
        Public Function SaveLadle(ByVal heat_number As Long, ByVal ladle_number As String, ByVal life As Integer, ByVal bottom As String, ByVal sidewall As String) As Boolean
            ...
            Try
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_ladle_details set ladle_number = @ladle_number , life = @life , " & _
                        " bottom = @bottom , sidewall = @sidewall where heat_number = @heat_number "
                Else
                    oCmd.CommandText = "insert into mm_ladle_details ( heat_number ,  " & _
                        " ladle_number , life , bottom , sidewall ) " & _
                        " values ( @heat_number , @ladle_number , " & _
        ...
        Public Function SaveBucket(ByVal heat_number As Long, ByVal bucket_number As String, ByVal entered_by As String, ByVal bucket_number2 As String, ByVal entered_by2 As String, ByVal bucket_number3 As String, ByVal entered_by3 As String) As Boolean
            ...
            Try
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_heat_bucket set bucket_number = @bucket_number , entered_by = @entered_by , " & _
                        " bucket_number2 = @bucket_number2 , entered_by2 = @entered_by2 , " & _
                        " bucket_number3 = @bucket_number3 , entered_by3 = @entered_by3 where heat_number = @heat_number "
                Else
                    oCmd.CommandText = "insert into mm_heat_bucket ( heat_number ,  " & _
                        " bucket_number , entered_by , bucket_number2 , entered_by2 , bucket_number3 , entered_by3  ) " & _
                        " values ( @heat_number , @bucket_number , " & _
        ...
        Public Function SaveHeatCharge(ByVal heat_number As Long, ByVal skull As Double, ByVal riser_hub As Double, ByVal cut_scrap As Double, ByVal hbi As Double, ByVal pygmy_pot As Double, ByVal wheel_cut As Double, ByVal lms As Double, ByVal slpr_cut As Double, ByVal hot_heal As Double, ByVal axle_cut As Double, ByVal tuning_boring As Double, ByVal wheel As Double, ByVal axle_end As Double, ByVal shredded_scrap As Double, ByVal nm_gunny_dust As Double, ByVal nm_calcium_lime As Double, ByVal Rail_Cut As Double, ByVal Remarks As String) As String
            ...
            Try
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_heat_sheet_charge set skull = @skull , " & _
                        " riser_hub = @riser_hub , cut_scrap = @cut_scrap , hbi = @hbi , pygmy_pot = @pygmy_pot , " & _
                        " wheel_cut = @wheel_cut , lms = @lms , slpr_cut = @slpr_cut , hot_heal = @hot_heal ,  " & _
                        " axle_cut = @axle_cut , tuning_boring = @tuning_boring , wheel = @wheel , axle_end = @axle_end , " & _
                        " shredded_scrap = @shredded_scrap , nm_gunny_dust = @nm_gunny_dust,  Remarks = @Remarks ," & _
                        " nm_calcium_lime = @nm_calcium_lime , Rail_Cut = @Rail_Cut where heat_number = @heat_number "
                Else
                    oCmd.CommandText = "insert into mm_heat_sheet_charge ( heat_number ,  " & _
                        " skull , riser_hub , cut_scrap , hbi,pygmy_pot , wheel_cut , lms , slpr_cut , hot_heal ,  " & _
                        " axle_cut , tuning_boring , wheel , axle_end , shredded_scrap , nm_gunny_dust ,  " & _
                        " nm_calcium_lime , Rail_Cut , Remarks )" & _
                        " values ( @heat_number , @skull , @riser_hub , @cut_scrap , @hbi , @pygmy_pot , " & _
                        " @wheel_cut , @lms , @slpr_cut , @hot_heal , @axle_cut , @tuning_boring , @wheel , " & _
        ...
        Public Function SaveFettling(ByVal heat_number As Long, ByVal ramming_mass_make As String, ByVal ramming_mass_quantity As Double, ByVal wet_ramming_mass_make As String, ByVal wet_ramming_mass_quantity As Double, ByVal gunning_mix_make As String, ByVal gunning_mix_quantity As Double)
            ...
            Try
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_fettling_details set ramming_mass_make = @ramming_mass_make , " & _
                       " ramming_mass_quantity = @ramming_mass_quantity , wet_ramming_mass_make = @wet_ramming_mass_make , " & _
                       " wet_ramming_mass_quantity = @wet_ramming_mass_quantity , gunning_mix_make = @gunning_mix_make ,  " & _
                       " gunning_mix_quantity = @gunning_mix_quantity where heat_number = @heat_number "
                Else
                    oCmd.CommandText = "insert into mm_fettling_details ( heat_number ,  " & _
                        " ramming_mass_make , ramming_mass_quantity , wet_ramming_mass_make , " & _
                        " wet_ramming_mass_quantity , gunning_mix_make , gunning_mix_quantity  ) " & _
                        " values ( @heat_number , " & _
                        " @ramming_mass_make , @ramming_mass_quantity , @wet_ramming_mass_make , " & _
        ...
        Public Function SaveElectrodeNew(ByVal heat_number As Long, ByVal eNo As String, ByVal Reason As String, ByVal Time As Date, ByVal Remarks As String, ByVal Location As String) As Boolean
            ...
            Try
                ...
                If eNo = "E1" Then
                    If Done Then
                        oCmd.CommandText = "update mm_electrode set e1Reason = @e1Reason , " & _
                                 " e1Time = @e1Time ,  e1remark = @e1remark , Location1 = @Location1" & _
                                 " where heat_number = @heat_number "
                    Else
                        oCmd.CommandText = "insert into mm_electrode " & _
                            " ( heat_number ,  e1Reason , e1Time ,  e1remark , Location1 ) " & _
                ...
                If eNo = "E2" Then
                    If Done Then
                        oCmd.CommandText = "update mm_electrode set e2Reason = @e2Reason , " & _
                                 " e2Time = @e2Time ,  e2remark = @e2remark , Location2 = @Location2 " & _
                                 " where heat_number = @heat_number "
                    Else
                        oCmd.CommandText = "insert into mm_electrode " & _
                            " ( heat_number ,  e2Reason , e2Time ,  e2remark , Location2 ) " & _
                ...
                If eNo = "E3" Then
                    If Done Then
                        oCmd.CommandText = "update mm_electrode set e3Reason = @e3Reason , " & _
                                 " e3Time = @e3Time ,  e3remark = @e3remark , Location3 = @Location3 " & _
                                 " where heat_number = @heat_number "
                    Else
                        oCmd.CommandText = "insert into mm_electrode " & _
                            " ( heat_number ,  e3Reason , e3Time ,  e3remark , Location3 ) " & _
        ...
        Public Function SaveElectrode(ByVal heat_number As Long, ByVal e1make As String, ByVal e1added As Double, ByVal e1tip_profile As String, ByVal e2make As String, ByVal e2added As Double, ByVal e2tip_profile As String, ByVal e3make As String, ByVal e3added As Double, ByVal e3tip_profile As String) As Boolean
            ...
            Try
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_electrode set " & _
                        " e1make = @e1make ,  e1added = @e1added ,  e1tip_profile = @e1tip_profile ,  " & _
                        " e2make = @e2make ,  e2added = @e2added ,  e2tip_profile = @e2tip_profile , " & _
                        " e3make = @e3make ,  e3added = @e3added ,  e3tip_profile = @e3tip_profile " & _
                        " where heat_number = @heat_number "
                Else
                    oCmd.CommandText = "insert into mm_electrode ( heat_number ,  " & _
                        " e1make , e1added ,  e1tip_profile , " & _
                        " e2make , e2added ,  e2tip_profile , " & _
                        " e3make , e3added ,  e3tip_profile ) " & _
                        " values ( @heat_number , " & _
                        " @e1make , @e1added ,  @e1tip_profile , " & _
                        " @e2make , @e2added ,  @e2tip_profile , " & _
        ...
        Public Function SaveNonMetailic(ByVal heat_number As Long, ByVal NCNL As Double, ByVal NGRD As Double, ByVal NLMS As Double) As Boolean
            ...
            Try
                ...
                oCmd.Parameters.Add("@cnt", SqlDbType.Int, 4).Direction = ParameterDirection.Output
                oCmd.CommandText = "select @cnt = count(*) FROM mm_nonmetal_addition " & _
                    " WHERE heat_number = @heat_number and pl_number = @pl_number "
                oCmd.ExecuteScalar()
                Done = IIf(IsDBNull(oCmd.Parameters("@cnt").Value), 0, oCmd.Parameters("@cnt").Value)
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_nonmetal_addition set quantity = @quantity  " & _
                        " where heat_number = @heat_number and pl_number = @pl_number "
                Else
                    oCmd.CommandText = "insert into mm_nonmetal_addition   " & _
                        " ( heat_number , pl_number , quantity ) " & _
        ...
        Public Function SaveInProcessAdditives(ByVal heat_number As Long, ByVal furnace_si_mn As Double, ByVal furnace_fe_si As Double, ByVal furnace_fe_mn As Double, ByVal furnace_floor_spar As Double, ByVal furnace_limestone As Double, ByVal ladle_si_mn As Double, ByVal ladle_fe_si As Double, ByVal ladle_fe_mn As Double, ByVal ladle_floor_spar As Double, ByVal ladle_limestone As Double, ByVal furnace_gunningdust As Double, ByVal ladle_gunningdust As Double, ByVal furnace_calcium_lime As Double, ByVal rsm_dept As Double, ByVal rsm_contract As Double, ByVal ContractNo As String) As Boolean
            ...
            Try
                ...
                oCmd.Parameters.Add("@cnt", SqlDbType.Int, 4).Direction = ParameterDirection.Output
                oCmd.CommandText = "select @cnt = count(*) FROM mm_inprocess_additives " & _
                    " WHERE heat_number = @heat_number "
                oCmd.ExecuteScalar()
                Done = IIf(IsDBNull(oCmd.Parameters("@cnt").Value), 0, oCmd.Parameters("@cnt").Value)
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_inprocess_additives " & _
                        " set furnace_si_mn = @furnace_si_mn , furnace_fe_si = @furnace_fe_si ," & _
                        " furnace_fe_mn = @furnace_fe_mn , furnace_floor_spar = @furnace_floor_spar , " & _
                        " furnace_limestone = @furnace_limestone , ContractNo = @ContractNo , " & _
                        " ladle_si_mn = @ladle_si_mn , ladle_fe_si = @ladle_fe_si , " & _
                        " ladle_fe_mn = @ladle_fe_mn , ladle_floor_spar = @ladle_floor_spar , " & _
                        " ladle_limestone = @ladle_limestone , furnace_gunningdust = @furnace_gunningdust , " & _
                        " ladle_gunningdust = @ladle_gunningdust ,  furnace_calcium_lime = @furnace_calcium_lime , " & _
                        " rsm_dept = @rsm_dept , rsm_contract = @rsm_contract where heat_number = @heat_number "
                Else
                    oCmd.CommandText = "insert into mm_inprocess_additives   " & _
                        " ( heat_number , furnace_si_mn , furnace_fe_si , furnace_fe_mn , furnace_floor_spar , " & _
                        " furnace_limestone , ladle_si_mn , ladle_fe_si , ladle_fe_mn , ladle_floor_spar , " & _
                        " ladle_limestone , furnace_gunningdust , ladle_gunningdust , furnace_calcium_lime , " & _
                        " rsm_dept , rsm_contract , ContractNo ) " & _
                        " values ( @heat_number , @furnace_si_mn , @furnace_fe_si , @furnace_fe_mn , @furnace_floor_spar , " & _
                        " @furnace_limestone , @ladle_si_mn , @ladle_fe_si , @ladle_fe_mn , @ladle_floor_spar , " & _
                        " @ladle_limestone , @furnace_gunningdust , @ladle_gunningdust , @furnace_calcium_lime , " & _
            ...
            Try
                ...
                If Done Then
                    ...
                    oCmd.CommandText = "update mm_spectro_results " & _
                        " set sample_temperature = @sample_temperature , sample_taken_time = @sample_taken_time ," & _
                        " ni_ni = @ni_ni , car_car = @car_car , sil_sil = @sil_sil ," & _
                ...
                Else
                    oCmd.CommandText = "insert into mm_spectro_results   " & _
                        " ( heat_number , sample_number , sample_temperature , sample_taken_time , " & _
                        " ni_ni , car_car , man_man , sil_sil , pho_pho , sul_sul , chr_chr , " & _
                        " cop_cop , alu_alu , Ven_Ven , moly_moly , nitro_nitro , hydro_hydro ) " & _
                        " values ( @heat_number , @sample_number , @sample_temperature , @sample_taken_time , " & _
                        " @ni_ni , @car_car , @man_man , @sil_sil , @pho_pho , @sul_sul , @chr_chr , " & _
        ...
        Public Function SaveDelay(ByVal heat_number As Long, ByVal fromtime As String, ByVal totime As String, ByVal remarks As String, ByVal delay_code As String) As Boolean
            ...
            Try
                ...
                oCmd.Parameters.Add("@cnt", SqlDbType.Int, 4).Direction = ParameterDirection.Output
                oCmd.CommandText = "select @cnt = count(*) FROM mm_process_delay " & _
                    " WHERE heat_number = @heat_number and delay_code = @delay_code "
                oCmd.ExecuteScalar()
                Done = IIf(IsDBNull(oCmd.Parameters("@cnt").Value), 0, oCmd.Parameters("@cnt").Value)
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_process_delay " & _
                        " set fromtime = @fromtime , totime = @totime ," & _
                        " remarks = @remarks where heat_number = @heat_number and delay_code = @delay_code  "
                Else
                    oCmd.CommandText = "insert into mm_process_delay   " & _
                        " ( heat_number , delay_code , fromtime , totime , remarks ) " & _
        ...
        Public Function SaveLadlePODetails(ByVal PONumber As String, ByVal InspCertificateNo As String, ByVal InspCertificateDate As Date, ByVal AcceptedQty As Integer, ByVal BricksSize As String, ByVal PLC As String, ByVal RUL As String, ByVal PCE As String, ByVal AP As String, ByVal Remarks As String) As Boolean
            ...
            Try
                ...
                oCmd.CommandText = "select @SlNo = SlNo FROM mm_LadlePODetails " & _
                ...
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_LadlePODetails " & _
                        " set InspCertificateDate = @InspCertificateDate , AcceptedQty = @AcceptedQty ," & _
                        " PLC = @PLC , RUL = @RUL , PCE = @PCE , AP = @AP , " & _
                        " Remarks = @Remarks WHERE PONumber = @PONumber and InspCertificateNo = @InspCertificateNo and BricksSize = @BricksSize  "
                Else
                    oCmd.CommandText = "insert into mm_LadlePODetails   " & _
                        " ( PONumber , InspCertificateNo , InspCertificateDate , AcceptedQty , " & _
                        " BricksSize , PLC , RUL , PCE , AP , Remarks  ) " & _
                        " values ( @PONumber , @InspCertificateNo , @InspCertificateDate , @AcceptedQty , " & _
        ...
        Public Function SaveRoofFixingDetails(ByVal RoofNo As String, ByVal FurnaceCode As String, ByVal FromHeatNo As Long, ByVal ToHeatNo As Long, ByVal Reason As String, ByVal Remarks As String) As Boolean
            ...
            Try
                ...
                End If
                oCmd.CommandText = "select @SlNo = count(*) FROM mm_RoofFixing " & _
                    " WHERE RoofNo = @RoofNo and FurnaceCode = @FurnaceCode and FromHeatNo = @FromHeatNo "
                oCmd.ExecuteScalar()
                Done = IIf(IsDBNull(oCmd.Parameters("@SlNo").Value), 0, oCmd.Parameters("@SlNo").Value)
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_RoofFixing " & _
                        " set ToHeatNo = @ToHeatNo , Reason = @Reason , Remarks = @Remarks , FromHeatNo = @FromHeatNo , " & _
                        " LiningNo = @LiningNo WHERE RoofNo = @RoofNo and FurnaceCode = @FurnaceCode and FromHeatNo = @FromHeatNo "
                Else
                    oCmd.CommandText = "insert into mm_RoofFixing   " & _
                        " ( RoofNo , FurnaceCode , FromHeatNo , ToHeatNo , Reason  , Remarks  , LiningNo ) " & _
        ...
        Public Function SaveContractNo(ByVal ContractNo As String, ByVal Qty As Double) As Boolean
            ...
            Try
                ...
                oCmd.Parameters.Add("@cnt", SqlDbType.Int, 4).Direction = ParameterDirection.Output
                oCmd.CommandText = "select @cnt = count(*) from mm_ContractQty " & _
                    " where ContractNo = @ContractNo "
                oCmd.ExecuteScalar()
                Done = IIf(IsDBNull(oCmd.Parameters("@cnt").Value), 0, oCmd.Parameters("@cnt").Value)
                If Done Then
                    Done = False
                    oCmd.CommandText = "update mm_ContractQty " & _
                        " set Qty = @Qty where ContractNo = @ContractNo "
                Else
                    oCmd.CommandText = "insert into mm_ContractQty   " & _
                        " ( ContractNo , Qty ) " & _
        ...
        Public Function SavePreHeatedLadleDetails(ByVal LadleNo As String, ByVal StartTime As Date, ByVal EndTime As Date, ByVal LiftingTemp As Integer, ByVal FromHeat As Double, ByVal ToHeat As Double, ByVal Remarks As String, ByVal LiningNo As String, ByVal StaffNo As String, ByVal Type As String, ByVal PreHeatID As Integer, Optional ByVal delete As Boolean = False) As Boolean
            ...
            Try
                ...
                oCmd.Transaction = oCmd.Connection.BeginTransaction
                If delete Then
                    oCmd.CommandText = "delete mm_PreHeatedLadleSetTemp " & _
                        " where PreHeatID = @PreHeatID "
                    oCmd.ExecuteNonQuery()
                    oCmd.CommandText = "delete mm_PreHeatedLadleDetails " & _
                        " where PreHeatID = @PreHeatID "
                Else
                    If PreHeatID > 0 Then
                        Done = False
                        oCmd.Parameters("@PreHeatID").Direction = ParameterDirection.Input
                        oCmd.CommandText = "update mm_PreHeatedLadleDetails " & _
                            " set EndTime = @EndTime , LiftingTemp = @LiftingTemp , FromHeat = @FromHeat , StaffNo = @StaffNo ," & _
                            " ToHeat = @ToHeat , Remarks = @Remarks , StartTime = @StartTime , Type = @Type " & _
                            " where LadleNo = @LadleNo and LiningNo = @LiningNo and PreHeatID = @PreHeatID "
                    Else
                        oCmd.CommandText = "insert into mm_PreHeatedLadleDetails   " & _
                            " ( LadleNo , StartTime , EndTime , LiftingTemp , FromHeat , ToHeat , Remarks , LiningNo , StaffNo , Type ) " & _
        ...
        Public Function SavePreHeatedLadleSetTemp(ByVal PreHeatID As String, ByVal SetDateTime As Date, ByVal LPH As Integer, ByVal HSDQty As Integer, ByVal SetTemp As Integer, ByVal ActualTemp As Double, ByVal Remarks As String, ByVal Staff As String, Optional ByVal SetID As Integer = 0) As Boolean
            ...
            Try
                ...
                Else
                    oCmd.CommandText = "insert into mm_PreHeatedLadleSetTemp   " & _
                      " ( PreHeatID , SetDateTime , LPH , HSDQty , SetTemp , ActualTemp , Staff , Remarks  ) " & _
        ...
        Public Function SaveFumeExtractionDetails(ByVal FromHeat As Long, ByVal ToHeat As Long, ByVal OffTime As Date, ByVal OnTime As Date, ByVal Remarks As String, ByVal SlNo As Integer, Optional ByVal Delete As Boolean = False) As Boolean
            ...
            Try
                ...
                If SlNo > 0 Then
                    If Delete Then
                        oCmd.CommandText = "delete mm_FumeExtraction " & _
                            " where FromHeat = @FromHeat and SlNo = @SlNo "
                    Else
                        oCmd.CommandText = "update mm_FumeExtraction " & _
                            " set ToHeat = @ToHeat , OffTime = @OffTime , OnTime = @OnTime , Remarks = @Remarks " & _
                            " where FromHeat = @FromHeat and SlNo = @SlNo "
                    End If
                Else
                    oCmd.CommandText = "insert into mm_FumeExtraction   " & _
                        " ( FromHeat , ToHeat , OffTime , OnTime ,  Remarks ) " & _
        ...
        Public Function SavePCDODetails(ByVal YearMonth As String, ByVal Accidents As Long, ByVal DAR As Integer, ByVal OT As Integer, ByVal PFNo As String, ByVal PFRemarks As String, Optional ByVal Delete As Boolean = False) As Boolean
            ...
            Try
                ...
                If IIf(IsDBNull(oCmd.Parameters("@PCDOId").Value), 0, oCmd.Parameters("@PCDOId").Value) = 0 Then
                    oCmd.CommandText = "insert mm_MeltPCDO ( YearMonth , Accidents , DAR , OT ) values " & _
                ...
                Else
                    ...
                    oCmd.CommandText = "update mm_MeltPCDO " & _
                        " set Accidents = @Accidents , DAR = @DAR , OT = @OT " & _
                ...
                oCmd.ExecuteScalar()
                If IIf(IsDBNull(oCmd.Parameters("@cnt").Value), 0, oCmd.Parameters("@cnt").Value) = 0 Then
                    oCmd.CommandText = "insert into mm_MeltPCDOList ( PCDOId , PFNo , PFRemarks ) " & _
                                    " values ( @PCDOId , @PFNo , @PFRemarks ) "
                Else
                    If Delete Then
                        oCmd.CommandText = "delete mm_MeltPCDOList where PCDOId = @PCDOId and  PFNo = @PFNo "
                    Else
                        oCmd.CommandText = "update mm_MeltPCDOList set PFRemarks = @PFRemarks " & _
