        ...
        Public Shared Function getUVData(ByVal UVDate As Date) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select convert(varchar(11),CalibrationDate,103) UVClaiDt , " &
                    " Shift Sh , LineNumber Line , Operator , copec1,copec2,copec3,copec4,
dragd1,dragd2,dragd3,dragd4, drag,tread , " &
        ...
        Public Shared Function getBHNData(ByVal BHNDate As Date) As DataTable
            ...
            Try
                ...
                da.SelectCommand.CommandText = "select convert(varchar(11),calibration_date,103) BHNClaiDt , " &
                    ...
                    " from ms_bhn_calibration_new where  calibration_date = @BHNDate "
                da.Fill(ds)
            ...
            Try
                If CalibrationType.ToLower = "mag" Then
                    da.SelectCommand.CommandText = "select Convert(Varchar(10),calibration_date,103) Dt , " &
                            " shift_code Sh , inspector , line_number Line , " &
                            " wheel_type WhlType , bath_concentration BathCon , results , remarks ,  SlNo " &
                            " from ms_magnaglow_calibration_new where calibration_date = @CalibrationDate " &
                ...
                ElseIf CalibrationType.ToLower = "ut" Then
                    da.SelectCommand.CommandText = "select Convert(Varchar(10),calibration_date,103) Dt , " &
                            ...
                            " results , remarks , SlNo , SetUp " &
                            " from ms_ut_calibration_new where calibration_date = @CalibrationDate and SetUp = 'results' " &
                            " and shift_code = @Shift and line_number = @LineNumber and wheel_type = @WhlType " &
                            " order by calibration_date desc ,  shift_code , line_number "
                ElseIf CalibrationType.ToLower = "ut setup" Then
                    da.SelectCommand.CommandText = "select Convert(Varchar(10),calibration_date,103) Dt , " &
                            ...
                            " from ms_ut_calibration_new where calibration_date = @CalibrationDate and SetUp = 'setup'" &
                            " and shift_code = @Shift and line_number = @LineNumber and wheel_type = @WhlType " &
                            " order by calibration_date desc ,  shift_code , line_number "
                End If
        ...
        Public Sub Save(Optional ByVal SlNo As Integer = 0)
            ...
            Try
                ...
                If IIf(IsDBNull(oCmd.Parameters("@SlNo").Value), 0, oCmd.Parameters("@SlNo").Value) = 0 Then
                    oCmd.CommandText = " insert into ms_magnaglow_calibration_new ( calibration_date , shift_code , inspector , line_number , wheel_type , bath_concentration , results , remarks , SavedDateTime ,cope )" &
                ...
                Else
                    oCmd.CommandText = " update ms_magnaglow_calibration_new set calibration_date = @calibration_date , shift_code = @shift_code , inspector = @inspector , " &
...
#Region " Methods"
        ...
        Public Sub Save(Optional ByVal SlNo As Integer = 0)
            ...
            Try
                ...
                If oCmd.Connection.State = ConnectionState.Closed Then oCmd.Connection.Open()
                If IIf(IsDBNull(oCmd.Parameters("@SlNo").Value), 0, oCmd.Parameters("@SlNo").Value) = 0 Then
                    oCmd.CommandText = " insert into ms_ut_calibration_new ( calibration_date , shift_code , inspector , line_number , wheel_type , time_from , time_to , results , remarks , SavedDateTime , SetUp ,cope )" &
                ...
                Else
                    oCmd.CommandText = " update ms_ut_calibration_new set calibration_date = @calibration_date , shift_code = @shift_code , inspector = @inspector , " &
...
#Region " Methods"
        ...
        Public Function SaveBHN() As Boolean
            ...
            Try
                ...
                Else
                    oCmd.CommandText = " update ms_bhn_calibration_new " &
                    ...
                    " results = @results , remarks = @remarks , cope=@cope , electop=@elect ,mechop= @mech" &
                    " where  calibration_date = @calibration_date and shift_code = @shift_code " &
                    " and line_number = @line_number and wheel_type = @wheel_type "
                End If
                If oCmd.ExecuteNonQuery() > 0 Then
...
#Region " Methods"
        ...
        Public Function SaveUV(Optional ByVal Sl As Integer = 0) As Boolean
            ...
            Try
                ...
                oCmd.Parameters.Add("@SlNo", SqlDbType.Int, 4).Direction = ParameterDirection.Output
                If oCmd.Connection.State = ConnectionState.Closed Then oCmd.Connection.Open()
                oCmd.CommandText = "select @SlNo = count(*) from ms_uv_calibration_new " & _
                    " where  CalibrationDate = @calibration_date and Shift = @shift_code " & _
                    " and LineNumber = @line_number "
                oCmd.ExecuteScalar()
                If IIf(IsDBNull(oCmd.Parameters("@SlNo").Value), 0, oCmd.Parameters("@SlNo").Value) = 0 Then
                    oCmd.CommandText = " insert into ms_uv_calibration_new " &
                    " ( CalibrationDate , Shift , LineNumber ," &
                    "  Operator , DueDate , Results , Remarks , SaveDateTime, copec1,copec2,copec3,copec4,dragd1,dragd2,dragd3,dragd4,drag,tread ) " &
                ...
                ElseIf oCmd.Parameters("@SlNo").Value = Sl Then
                    oCmd.CommandText = " update ms_uv_calibration_new " &
                    " set Operator = @inspector ,  " &
                    "  DueDate = @DueDate , " &
                    " Results = @Results , remarks = @remarks  , copec1=@copeone , copec2=@copetwo ,copec3=@copethree , copec4=@copefour ,dragd1=@dragone,dragd2=@dragtwo,dragd3=@dragthree,dragd4=@dragfour,drag=@drag,tread=@tread" &
