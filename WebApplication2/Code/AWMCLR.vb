Namespace RWF
    <Serializable()> Public Class AWMCLR
        ...
        Public Shared Function GetWheelShopFloorBalance(ByVal dt As Date) As DataTable
            ...
            End Try
        End Function
        Public Function Save(ByVal InputDate As Date, ByVal Shift As String, ByVal Operator1 As String, ByVal CBForDate As Date, ByVal QTY As DataTable) As Boolean
            ...
            sUpdateTrans = "Update mm_WheelShopFloorBalance_ReconciledCB set InputDate = @InputDate, InputShift = @InputShift, Operator_code = @Operator_code, CBQty= @CBQty, SavedDateTime = @SavedDateTime " &
            " where  ProductCode = @ProductCode and CBForDate = @CBForDate "

            sInsertTrans = "Insert into mm_WheelShopFloorBalance_ReconciledCB (InputDate, InputShift, Operator_code, ProductCode, CBForDate, CBQty, SavedDateTime ) " &
                  " values (@InputDate, @InputShift, @Operator_code, @ProductCode, @CBForDate, @CBQty, @SavedDateTime)"
