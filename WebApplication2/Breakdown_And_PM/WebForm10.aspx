...
<%--               <asp:CheckBox ID="chbox1" runat="server" AutoPostBack="True" CssClass="form-control" ></asp:CheckBox>
           --%> <div class="row">
                <div class="col" align="center">
                          <%-- <asp:button id="btnSave" runat="server" Text="Add"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button>--%>
          ...
          <asp:datagrid id="DataGrid1" CssClass="table" runat="server" CellPadding="1" CellSpacing="1" AutoGenerateColumns="False" forecolor="Black">
                    ...
                    <asp:BoundColumn DataField="Feild" HeaderText="Item to be inspected"></asp:BoundColumn>
                                   <asp:TemplateColumn HeaderText="Action Taken">
                             <ItemTemplate>
                               <asp:textbox id="txt1" runat="server" CssClass="form-control" AutoPostBack="True"></asp:textbox>
                             </ItemTemplate>
                         </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="Final Review">
                             <ItemTemplate>
                               <asp:textbox id="txt2" runat="server" CssClass="form-control" AutoPostBack="True"></asp:textbox>
                             </ItemTemplate>
                         </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="Remarks">
                             <ItemTemplate>
                               <asp:textbox id="txt3" runat="server" CssClass="form-control" AutoPostBack="True"></asp:textbox>
                             </ItemTemplate>
                         </asp:TemplateColumn>
               </Columns>
                    </asp:datagrid>
