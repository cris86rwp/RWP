		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1"  runat="server">
				<TABLE id="Table1" class="table">
					<TR>
						<TD colSpan="6"><FONT size="5">MR Mould Transaction Edit Remarks</FONT><hr class="prettyline" /></TD>
					</TR>
					<TR>
						<TD colSpan="6">
					...
					<TR>
						...
						<TD>:</TD>
						<TD>
							<asp:textbox id="txtDate" runat="server" AutoPostBack="True" CssClass="form-control" BorderStyle="Groove"></asp:textbox></TD>
						<TD>Shift</TD>
						<TD>:</TD>
						<TD>
					...
					<TR>
						<TD vAlign="top" align="middle" colSpan="6">
							<asp:DropDownList id="ddlMoulds" runat="server" CssClass="form-control ll" AutoPostBack="True"></asp:DropDownList></TD>
					</TR>
					<TR>
						<TD vAlign="top" align="left" colSpan="6">Remrks :
							<asp:DropDownList id="ddlRemarks" runat="server" CssClass="form-control ll"></asp:DropDownList></TD>
					</TR>
					<TR>
						<TD vAlign="top" align="middle" colSpan="6">
