		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1"  runat="server">
				<TABLE id="Table1" class="table">
					<TR>
						<TD  colSpan="6"><FONT size="5">New&nbsp;Mould Introduction-- Edit</FONT><hr class="prettyline" /></TD>
					</TR>
					<TR>
						<TD>Message</TD>
						<TD>:</TD>
						...
						<TD>
							...
							<asp:Panel id="pnlDrag" runat="server">
								<TABLE id="Table2" Class="table">
									<TR>
										<TD>
											<asp:panel id="PanelEngraved_number" runat="server" >EngravedNo</asp:panel></TD>
										<TD>
										...
										<TD>
											<asp:label id="Label1" runat="server">IngateSupplier</asp:label></TD>
										<TD>
