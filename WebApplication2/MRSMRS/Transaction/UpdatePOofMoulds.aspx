		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel1"  runat="server">
				<TABLE id="Table1" class="table">
					<TR>
						<TD colSpan="3"><FONT size="5">Update PO 
								Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								&nbsp;
					...
					<TR>
						...
						<TD >:</TD>
						<TD >
							<asp:TextBox id="txtMldNo" runat="server" AutoPostBack="True" CssClass="form-control" MaxLength="5" ToolTip="enter 5-digit mould number(only numeric)" onkeypress="OnlyNumericEntry()"></asp:TextBox></TD>
					</TR>
					<TR>
						<TD >ProductID</TD>
						<TD >:</TD>
					...
					<TR>
						...
						<TD>:</TD>
						<TD>
							<asp:textbox id="txtPONumber" runat="server" AutoPostBack="True" CssClass="form-control" ToolTip="enter New Product order number(only numeric)" onkeypress="OnlyNumericEntry()"></asp:textbox></TD>
					</TR>
					<TR>
						<TD vAlign="top" align="middle" colSpan="3">
							<asp:Button id="btnSave" runat="server" Text="Update" CssClass="button button2"></asp:Button></TD>
					</TR>
				</TABLE>
				...
				<TABLE id="Table2" class="table">
					<TR>
						<TD colSpan="3">Update Firm Name</TD>
					</TR>
					<TR>
						<TD>MouldNumber</TD>
						<TD>:</TD>
						<TD>
							<asp:TextBox id="txtMould" runat="server" AutoPostBack="True" CssClass="form-control" ToolTip="enter 6-digit mould number(only numeric)" onkeypress="OnlyNumericEntry()"></asp:TextBox></TD>
					</TR>
					<TR>
						<TD colSpan="3">
					...
					<TR>
                        ...
                        <td></td>
						<TD>
							<asp:DropDownList id="ddlSupplierCode" runat="server" CssClass="form-control ll"></asp:DropDownList></TD>
					</TR>
					<TR>
						<TD colSpan="3">
							<asp:Button id="btnFirm" runat="server" Text="Change Firm" CssClass="button button2"></asp:Button></TD>
					</TR>
				</TABLE>
