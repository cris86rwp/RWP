...
Public Class PrePouring
    ...
    Public Function savepre()
        ...
        If Not RWF.tables.CheckHeat_pre(txtHeatNumber.Text) Then
            Try
                con.ConnectionString = "Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;Persist Security Info=True;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy"
                con.Open()
                cmd.Connection = con
                cmd2.Connection = con
