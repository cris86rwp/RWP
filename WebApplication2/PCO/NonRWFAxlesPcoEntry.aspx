<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NonRWFAxlesPcoEntry.aspx.vb" Inherits="WebApplication2.NonRWFAxlesPcoEntry" smartNavigation="True" %>
<!DOCTYPE HTML >
<HTML>
	<HEAD>
		<title>NonRWFAxlesPcoEntry</title>
	...
	<body  >
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" class="table">
				<TR>
					<TD noWrap="nowrap" align="center" colSpan="6"><STRONG><FONT size="4">Non-RWF Axles PCO Entry</FONT></STRONG><hr class="prettyline" /></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD noWrap="nowrap"><asp:textbox id="txtCastHeatNo" tabIndex="2" runat="server" AutoPostBack="True" CssClass="form-control"></asp:textbox></TD>
					<TD noWrap="nowrap" colSpan="3">Customer Axle Number</TD>
					<TD noWrap="nowrap"><asp:textbox id="txtCustAxleNo" tabIndex="3" runat="server" AutoPostBack="True" CssClass="form-control"></asp:textbox></TD>
				</TR>
				<TR>
					<TD noWrap="nowrap" align="center" colSpan="6"><asp:button id="BtnSave" tabIndex="4" runat="server" CssClass="button button4" Text="Save"></asp:button></TD>
				</TR>
				<TR>
					<TD noWrap="nowrap" colSpan="6"><asp:datagrid id="dgData" tabIndex="-1" runat="server" BorderColor="White" BorderStyle="Ridge" CellSpacing="1" BorderWidth="2px" BackColor="White" CellPadding="3" GridLines="None" CssClass="table">
