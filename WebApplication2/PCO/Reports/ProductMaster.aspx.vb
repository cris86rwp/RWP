Public Class ProductMaster
    ...
    Protected WithEvents rblProductService As System.Web.UI.WebControls.RadioButtonList
    Protected WithEvents lblMessage As System.Web.UI.WebControls.Label
    Protected WithEvents rblCondition As System.Web.UI.WebControls.RadioButtonList
    ...
    Protected WithEvents rblClass As System.Web.UI.WebControls.RadioButtonList
    ...
    Protected WithEvents rblProductNature As System.Web.UI.WebControls.RadioButtonList
    ...
    Protected WithEvents rdoR43R16 As System.Web.UI.WebControls.RadioButtonList
    ...
    Protected WithEvents rdoSimilarProds As System.Web.UI.WebControls.RadioButtonList
    Protected WithEvents chkInputs As System.Web.UI.WebControls.CheckBox
    Protected WithEvents rblInitialStage As System.Web.UI.WebControls.RadioButtonList
...
#End Region
    ...
    Private Sub setobj()
        ...
        Session.Remove("PCO")
        txtProductCode.Text = ""
        Dim oProduct As New PCO.Product(rblProduct.SelectedItem.Value, rblProductNature.SelectedItem.Value, rblProductService.SelectedItem.Value, rblCondition.SelectedItem.Value)
            ...
            If CType(Session("Product"), PCO.Product).Axle Then
                Try
                    ...
                    Else
                        Done = False
                        Try
                            Select Case rblInitialStage.SelectedItem.Text.Trim
                                Case "FG"
                                    InitialStage = "FG"
                            ...
                            End Select
                            CType(Session("Product"), PCO.Product).R43R16 = rdoR43R16.SelectedItem.Text
                        Catch exp As Exception
                            lblMessage.Text = CType(Session("Product"), PCO.Product).Message & "  " & exp.Message
                        End Try
                    End If
...
#Disable Warning BC42104 ' Variable is used before it has been assigned a value
                        If CType(Session("Product"), PCO.Product).Save(txtProductCode.Text.Trim, rblMake.SelectedItem.Text.Trim, rblSource.SelectedItem.Text.Trim, rblInitialStage.SelectedItem.Text.Trim, NextRTProdCode, NextFIProdCode) Then Done = True
...
#Enable Warning BC42104 ' Variable is used before it has been assigned a value
    ...
    Private Sub btnCheckList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCheckList.Click
        ...
        strPathName = " http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=5861&user0=crissqlserver&password0=cris-bela@1234567890" &
