    ...
    Private Sub btnShowReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShowReport.Click
        If btnShowReport.Text.StartsWith("Show") Then
            ...
            If rblGroup.SelectedIndex = 0 Then
                strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=13901&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=cris-bela@1234567890&promptonrefresh=0" &
                        "&prompt0=" & rblGroup.SelectedItem.Value & "" &
                        "&prompt1=" & ddlRefID.SelectedItem.Value & "" &
                        "&prompt2=" & rblInvoice.SelectedItem.Value & ""
            ElseIf rblGroup.SelectedIndex = 1 Then
                strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=13901&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=cris-bela@1234567890&promptonrefresh=0" &
                        "&prompt0=" & rblGroup.SelectedItem.Value & "" &
                        "&prompt1=" & ddlDespatchAdviceNo.SelectedItem.Value & "" &
                        "&prompt2=" & rblInvoice.SelectedItem.Value & ""
            ElseIf rblGroup.SelectedIndex = 2 Then
                strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=13901&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=cris-bela@1234567890&promptonrefresh=0" &
                        "&prompt0=" & rblGroup.SelectedItem.Value & "" &
                        "&prompt1=" & ddlSaleOrders.SelectedItem.Value & "" &
                        "&prompt2=" & rblInvoice.SelectedItem.Value & ""
            ElseIf rblGroup.SelectedIndex = 3 Then
                strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=13901&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=cris-bela@1234567890&promptonrefresh=0" &
                        "&prompt0=" & rblGroup.SelectedItem.Value & "" &
                        "&prompt1=" & ddlDespatchAdviceNo.SelectedItem.Value & "" &
                        "&prompt2=" & rblInvoice.SelectedItem.Value & ""
