		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:Panel id="Panel1" runat="server">
				<TABLE id="Table2" class="table">
					<TR>
						<TD align="middle"><h2>Enter Work Order No.</h2><hr class="prettyline" /></TD>
					</TR>
					<TR>
				...
				<TABLE id="Table1" class="table">
					<TR>
						...
						<TD>:</TD>
						<TD>
							<asp:textbox id="txtDate" runat="server" CssClass="form-control" BorderStyle="Groove" AutoPostBack="True" onkeypress="return isNumber1(event,this)" MaxLength="10" ></asp:textbox>
