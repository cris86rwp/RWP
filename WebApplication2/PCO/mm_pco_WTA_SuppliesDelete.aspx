<%@ Page Language="vb" AutoEventWireup="false" Codebehind="mm_pco_WTA_SuppliesDelete.aspx.vb" Inherits="WebApplication2.mm_pco_WTA_SuppliesDelete" %>
<!DOCTYPE HTML>
<html  xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		<title>mm_pco_WTA_SuppliesDelete</title>
...
<!--/.Navbar -->
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1"  class="table">
				...
				<TR>
					<TD colSpan="3"><asp:datagrid id="dgPlanDetails" runat="server" AutoGenerateColumns="False">
					...
					<asp:panel id="pnlPlan" runat="server" Visible="True" >
							...
							<TABLE id="Table3"  class="table">
                               <%-- style="WIDTH: 351px; HEIGHT: 109px" cellSpacing="1" cellPadding="1" width="351"--%>
								...
								<TR>
									...
									<TD>:</TD>
									<TD>
										<asp:textbox id="txtOrderedQty" runat="server" AutoPostBack="True" CssClass="form-control "></asp:textbox></TD>
								</TR>
								<TR>
									<TD>Remarks</TD>
									<TD>:</TD>
				...
				<TR>
					<TD vAlign="top" align="left" colSpan="3"><asp:datagrid id="dgData" runat="server" BackColor="White" Height="160px" CellPadding="4" BorderWidth="1px" BorderStyle="None" BorderColor="#3366CC">
