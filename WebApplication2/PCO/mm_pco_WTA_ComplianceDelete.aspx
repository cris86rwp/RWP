<%@ Page Language="vb" AutoEventWireup="false" Codebehind="mm_pco_WTA_ComplianceDelete.aspx.vb" Inherits="WebApplication2.mm_pco_WTA_ComplianceDelete" Culture="en-GB" uiCulture="en-GB" %>
<!DOCTYPE HTML>
<HTML xmlns="http://www.w3.org/1999/xhtml">
	<HEAD runat="server">
		<title>mm_pco_WTA_ComplianceDelete</title>
...
<!--/.Navbar -->
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" class="table" >
				<TR>
					<TD colSpan="3"><FONT size="5">WTA Compliance</FONT<hr class="prettyline" /><TD>
				</TR>
				<TR>
					<TD colSpan="3">Mode :
				...
				<TR>
					<TD colSpan="3">Message :
						...
						<TABLE id="Table7"  class="table" <%--cellSpacing="1" cellPadding="1" width="300"--%> >
							<TR>
								<TD>DC Number&nbsp; :&nbsp;
							...
							<TR>
								...
								<TD vAlign="top" align="center">&nbsp;
									...
									<TABLE id="Table8" class="table" >
										...
										<TR>
											<TD colSpan="3"><asp:button id="btnShowDespatches" runat="server" Text="Show Compliance" CssClass="button button2"></asp:button>&nbsp;</TD>
										</TR>
									</TABLE>
				...
				<TR>
					<TD colSpan="3"><asp:datagrid id="DataGrid1" runat="server" CssClass="table">
				...
				<TR>
					<TD colSpan="3">
						<asp:Panel id="pnlCompliance" runat="server" >
							<asp:DataGrid id="dgDCNumbers" runat="server" CssClass="table">
                                <SelectedItemStyle Font-Bold="True" ForeColor="#663399" BackColor="#FFCC66"></SelectedItemStyle>
					<ItemStyle ForeColor="#330099" BackColor="White"></ItemStyle>
					<HeaderStyle Font-Bold="True" ForeColor="#FFFFCC" BackColor="#990000"></HeaderStyle>
					<FooterStyle ForeColor="#330099" BackColor="#FFFFCC"></FooterStyle>
