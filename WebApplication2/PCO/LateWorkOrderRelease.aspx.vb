...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Page.IsPostBack = False Then
            ...
            strHelp.Append("1.Work order should belong to previous months")
            strHelp.Append("<BR>")
            strHelp.Append("2.There should not be any work order to that shop for that month for same Prodcut")
            strHelp.Append("<BR>")
            strHelp.Append("3. Late workorders cannot be used to generate RMRs")
