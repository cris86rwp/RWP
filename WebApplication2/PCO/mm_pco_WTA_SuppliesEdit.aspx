<%@ Page Language="vb" AutoEventWireup="false" Codebehind="mm_pco_WTA_SuppliesEdit.aspx.vb" Inherits="WebApplication2.mm_pco_WTA_SuppliesEdit"  %>
<!DOCTYPE HTML>
<html  xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		<title>mm_pco_WTA_SuppliesEdit</title>
             ...
             <%--   style="Z-INDEX: 101; LEFT: 7px; WIDTH: 402px; POSITION: absolute; TOP: 4px; HEIGHT: 447px" cellSpacing="1" cellPadding="1" width="402"--%>
				<TR>
					<TD colSpan="3" align="middle"><h2>WTA Planned Quantities&nbsp;(&nbsp;Details 
							Consignee-wise&nbsp;)</h2><hr class="prettyline" /></TD>
				</TR>
				<TR>
					<TD colSpan="3">Mode :
				...
				<TR>
					<TD colSpan="3"><asp:datagrid id="dgPlanDetails" runat="server" AutoGenerateColumns="False" CssClass="table">
                              ...
                              <%--  style="WIDTH: 351px; HEIGHT: 109px" cellSpacing="1" cellPadding="1" width="351"--%>
								<TR>
									...
									<TD>
										...
										<asp:Label id="lblSupplyID" runat="server"  Visible="False"></asp:Label></TD>
								</TR>
								<TR>
									<TD>PO Number</TD>
									<TD></TD>
								...
								<TR>
									...
									<TD>:</TD>
									<TD>
										<asp:textbox id="txtOrderedQty" runat="server" cssclass="form-control" AutoPostBack="True" ToolTip="eneter ordered qty(only numeric)" onkeypress="OnlyNumericEntry()"></asp:textbox></TD>
								</TR>
								<TR>
									<TD>Remarks</TD>
									<TD>:</TD>
									<TD>
										<asp:textbox id="txtSupplyRemarks" runat="server" cssclass="form-control" MaxLength="250"></asp:textbox></TD>
								</TR>
								<TR>
									<TD vAlign="top" align="middle" colSpan="3">
										<asp:button id="btnSave" runat="server" Text="Save  Changes" CssClass="button button2"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<TR>
					<TD vAlign="top" align="left" colSpan="3"><asp:datagrid id="dgData" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="160px">
