...
<script type="text/javascript" src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  ...
  <div class="collapse navbar-collapse " id="navbarSupportedContent-333" >
    ...
    <form id="form1" runat="server">
        ...
        <div><asp:label id="lblMessage" runat="server" ForeColor="red"></asp:label><br />
           <div class="row">
            ...
            <asp:textbox id="Tech" runat="server" CssClass="form-control" Visible="false"></asp:textbox>
            
            <asp:textbox id="txtDefect" runat="server" CssClass="form-control" Visible="false"></asp:textbox>
            ...
            <asp:datagrid id="DataGrid1" CssClass="table" runat="server" CellPadding="1" CellSpacing="1" AutoGenerateColumns="False" forecolor="Black">
                    ...
                    <asp:BoundColumn DataField="BDType" HeaderText="BD Type"></asp:BoundColumn>
                         ...
                         <asp:BoundColumn DataField="TechEmpname" HeaderText="TechnicianName"></asp:BoundColumn>
                       ...
                       <asp:BoundColumn DataField="SseRemarks" HeaderText="SseRemarks"></asp:BoundColumn>
                        <asp:BoundColumn DataField="TechRemark" HeaderText="TechnicianRemarks"></asp:BoundColumn>
    <asp:BoundColumn DataField="AddWork" HeaderText="TechnicianRemarks" Visible="false"></asp:BoundColumn>
    ...
    <asp:BoundColumn DataField="Operator" HeaderText="Operator" Visible="false"></asp:BoundColumn>
            ...
            <div class="row">
                <div class="col"><asp:label id="Label2" runat="server" ForeColor="black" Text="Additional Mechanical Work"></asp:label></div>
                <div class="col"><asp:label id="AddWork" runat="server" ForeColor="black"></asp:label></div>
            </div><br />
             <asp:datagrid id="DataGrid2" CssClass="table" runat="server" CellPadding="1" CellSpacing="1" AutoGenerateColumns="False" forecolor="Black">
                    ...
                    <Columns>
                                <%--   <asp:ButtonColumn Text="Select" HeaderText="select" CommandName="select"></asp:ButtonColumn>  --%>
                    <asp:BoundColumn DataField="PL_No" HeaderText="PL NO."></asp:BoundColumn>
                    <asp:BoundColumn DataField="PL_Desc1" HeaderText="DESCRIPTION"></asp:BoundColumn>
            ...
            <asp:button id="btnSave" runat="server" Text="Send to User"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button>&nbsp;
                    
            <asp:button id="BtnTech" runat="server" Text="Technician Reallotment"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button>&nbsp;
