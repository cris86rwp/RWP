Public Class WFPSRegisterReport
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        If rblType.SelectedItem.Value = 1 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=17731&user0=crissqlserver&password0=cris-bela@1234567890" &
      "&prompt0=" & Val(txtHeatNumber.Text) & "" &
                    "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            Response.Redirect(strPathName)
            'ElseIf rblType.SelectedItem.Value = 2 Then
            '    strPathName =  "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=8497&user0=crissqlserver&password0=cris-bela@1234567890" &
            '            "&prompt0=" & Val(txtHeatNumber.Text) & "" &
            '            "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            '    Response.Redirect(strPathName)
        ElseIf rblType.SelectedItem.Value = 3 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=17752&user0=crissqlserver&password0=cris-bela@1234567890" &
     "&prompt0=" & Val(txtHeatNumber.Text) & "" &
                    "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            Response.Redirect(strPathName)
            'ElseIf rblType.SelectedItem.Value = 4 Then
            '    strPathName =  "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=17775&user0=crissqlserver&password0=cris-bela@1234567890" &
            '            "&prompt0=" & Val(txtHeatNumber.Text) & "" &
            '            "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            '    Response.Redirect(strPathName)
        ...
        ElseIf rblType.SelectedItem.Value = 6 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=8531&user0=crissqlserver&password0=cris-bela@1234567890" &
                     "&prompt0=" & Val(txtHeatNumber.Text) & "" &
                    "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            Response.Redirect(strPathName)
        ElseIf rblType.SelectedItem.Value = 7 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=8538&user0=crissqlserver&password0=cris-bela@1234567890" &
              "&prompt0=" & Val(txtHeatNumber.Text) & "" &
                    "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            Response.Redirect(strPathName)
        ElseIf rblType.SelectedItem.Value = 8 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=8545&user0=crissqlserver&password0=cris-bela@1234567890" &
                     "&prompt0=" & Val(txtHeatNumber.Text) & "" &
                    "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            Response.Redirect(strPathName)
        ElseIf rblType.SelectedItem.Value = 9 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=17881&user0=crissqlserver&password0=cris-bela@1234567890" &
                    "&prompt0=" & Val(txtHeatNumber.Text) & "" &
                    "&prompt1=" & Val(rblType.SelectedItem.Value) & ""
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=8517&user0=crissqlserver&password0=cris-bela@1234567890" &
