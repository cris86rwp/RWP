    ...
    <ul class="navbar-nav ml-auto  navbar-right">
     ...
     <div class="container">
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 13px; WIDTH: 395px; POSITION: absolute;  HEIGHT: 300px" cellSpacing="1" cellPadding="1" width="395" border="0">
				<TR>
					<TD vAlign="center" align="middle" width="100%" colSpan="4">&nbsp;&nbsp;&nbsp;Cleaning 
						Room 302 Form</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD vAlign="center" align="right" colSpan="4">
						<asp:button id="BtnShow" runat="server" Height="30px" Width="120px"  CssClass="form-control" BorderStyle="Groove" Font-Size="Smaller" Font-Names="Arial" Text="Show Report"></asp:button></TD>
				</TR>
			</TABLE>
		</form>
