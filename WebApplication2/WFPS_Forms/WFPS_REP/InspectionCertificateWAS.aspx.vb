...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If IsPostBack = True Then
            btnReport.Text = "Show " & rblType.SelectedItem.Text = "W" & "  QAC Report"
        End If
    End Sub
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        If rblType.SelectedItem.Value = "W" Then
            If txtDCNumber.Text.StartsWith("W") Then
                strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=8561&user0=crissqlserver&password0=cris-bela@1234567890" &
