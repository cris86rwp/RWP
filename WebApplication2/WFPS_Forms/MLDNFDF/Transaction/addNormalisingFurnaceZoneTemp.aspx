<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="addNormalisingFurnaceZoneTemp.aspx.vb" Inherits="WebApplication2.addNormalisingFurnaceZoneTemp" %>

 <!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head runat="server">
		<title>add Normalising Furnace Zone Temp</title>
       ...
       <li class="nav-item">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table id="Table1"  class="table">
				<tr>
					<td  colspan="8"><font size="3">Normalising Furnace Zone 
				...
				<tr>
					<td " colspan="8"><asp:label id="Message" runat="server" ForeColor="Red"></asp:label></td>
				</tr>
				<tr>
					<td>Date:</td>
...
<%--Selected="True"--%>     <asp:ListItem Value="select">Select</asp:ListItem>
                ...
                <tr>
                  ...
                  <%--  <td><asp:Label ID="Zone7" runat="server" Text="Zone7_Temp"></asp:Label></td>--%>
                   <%--  <td>     <asp:TextBox ID="Zone7t" CssClass="form-control" runat="server"></asp:TextBox></td>
                    <td><asp:Label ID="Zone8" runat="server" Text="Zone8_Temp"></asp:Label></td>
                       <td>     <asp:TextBox ID="Zone8t" CssClass="form-control" runat="server"></asp:TextBox></td>--%>
                    </tr>
