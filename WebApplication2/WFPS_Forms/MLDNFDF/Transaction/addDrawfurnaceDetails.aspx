<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="addDrawfurnaceDetails.aspx.vb" Inherits="WebApplication2.DrawfurnaceDetails" %>
        ...
        <div class="row">
			...
			<table id="Table1" class="table" >
              ...
              <td colspan="9"><asp:label id="Message" runat="server" ForeColor="Red"></asp:label></td>
					...
					<td>:</td>
					<td><asp:textbox id="txtNF_date" onkeypress="return isNumber1(event,this)" placeholder="mm/dd/yyyy" MaxLength="10" CssClass="form-control" AutoPostBack="true"  runat="server"></asp:textbox></td>
