	 ...
	 <div class="row">
			...
			<table id="Table1" class="table" >
				...
				<tr>
					...
					<td>:</td>
					<td><asp:textbox id="txtNF_date" CssClass="form-control" onkeypress="return isNumber1(event,this)"  placeholder="mm/dd/yyyy" MaxLength="10" runat="server" AutoPostBack="true" ></asp:textbox></td>
