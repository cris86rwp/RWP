							...
							<asp:panel id="Panel1" runat="server" >
								<TABLE id="Table2" class="table">
									...
									<TR>
										<TD>Date</TD>
										<TD>
											<asp:textbox id="txtDate" runat="server" CssClass="form-control" ToolTip="date format mm/dd/yyyy" onkeypress="OnlyNumericEntry()"></asp:textbox></TD>
										<TD colSpan="2">
										...
										<TD style="WIDTH: 100px">
											<asp:textbox id="txtOperator" runat="server" CssClass="form-control" AutoPostBack="True" ToolTip="Enter Operator" onkeypress="OnlyNumericEntry()"></asp:textbox></TD>
									</TR>
									<TR>
										...
										<TD>Sr. No</TD>
										<TD>
											<asp:textbox id="txtSrNo" runat="server" CssClass="form-control" ToolTip="Enter Ped Number(only numeric)" onkeypress="OnlyNumericEntry()"></asp:textbox></TD>
										<%--<TD>QuenchNo</TD>
										<TD>
									...
									<TR>
										...
										<TD colSpan="2" style="width:100px">
											<asp:Label id="lblSl_No" runat="server" Visible="true"></asp:Label>
								...
								<asp:DataGrid id="DataGrid1" runat="server" CssClass="table" AutoGenerateColumns="False" CellPadding="4" BackColor="White" BorderWidth="1px" BorderStyle="None" BorderColor="#CC9966">
									...
									<Columns>
										...
										<asp:BoundColumn DataField="PNo" ReadOnly="True" HeaderText="SrNo"></asp:BoundColumn>
