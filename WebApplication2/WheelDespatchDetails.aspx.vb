...
Public Class WheelDespatchDetails
    ...
    End Sub
    'Pankaj Motwani:Two queries mentioned at line nos 282 and 290 can be made single by using OR operator'
    ...
    Private Sub BindDataGrid(ByVal strArg As String)
        ...
        Catch exp As SqlException
            ...
            'Pankaj Motwani: Line nos should not be displayed to end user for message display'
        Catch exp As Exception
            strsql = exp.StackTrace
            lblMessage.Text = "Line : " & Mid(strsql, InStr(strsql, "line") + 5) & " Message : " + exp.Message
        End Try
    ...
    Protected Sub sendSMS()
        ...
        Try
            ...
            'Pankaj Motwani: Better to take mobile no from employee master rather than fetching it from different table'
            ...
            End While
            'Pankaj Motwani: Requires error handling by capturing additonal parameters 
            'which comes As a part Of outpout/POS. Additional checks To be done If webAPI Is down/Not accesible
            'Like success, retry attempts And balance checks'
