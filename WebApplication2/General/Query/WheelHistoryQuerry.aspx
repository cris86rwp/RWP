		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="pnlMain" runat="server">
				<TABLE id="Table1" class="table">
					<TR>
						<TD><h2>Wheel History (RWP)</h2><hr class="prettyline" /></TD>
					</TR>
					<TR>
						<TD>
					...
					<TR>
						<TD>WheelNumber/HeatNumber
							<asp:TextBox id="txtWheel" runat="server" CssClass="form-control" AutoPostBack="True" onkeypress="OnlyNumericEntry()" MaxLength="6" ToolTip="enter wheel or heat number(only numeric)"></asp:TextBox>
							<asp:checkbox id="chkRefresh" runat="server" AutoPostBack="True" Text="Refresh" TextAlign="Left"></asp:checkbox></TD>
					</TR>
				</TABLE>
