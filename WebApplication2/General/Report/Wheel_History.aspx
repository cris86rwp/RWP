...
<head runat="server">
  ...
  <div class="collapse navbar-collapse " id="navbarSupportedContent-333">
    ...
    <ul class="navbar-nav ml-auto  navbar-right">
     ...
     <div class="container">
            <div class="row">
                <div id="at1" class="table-responsive">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Panel id="Panel1" runat="server">
                <table id="Table1" class="table">
                    ...
                    <tr>
                        <td >WheelNo :</td>
                        <td>
                            <asp:TextBox ID="txtWheel" runat="server" Width="120px" BorderStyle="Groove" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txtWheel">*</asp:RequiredFieldValidator></td>
                        <td>HeatNo. :</td>
                        <td>
                            <asp:TextBox ID="txtHeat" runat="server" Width="120px" BorderStyle="Groove" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvld2" runat="server" Display="Dynamic" ControlToValidate="txtHeat">*</asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="BtnShow" runat="server" BorderStyle="Groove" Text="Show Report"  CssClass="btn btn-light" Width="211px"></asp:Button></td>
                        <td>
                            <asp:Button ID="Button1" runat="server" Text="Set WO for the Wheel" CssClass="btn btn-light" Width="211px"></asp:Button></td>
                    </tr>
                </table>
          ...
          <div class="card-footer" style="text-align:right; margin-top:200px;">
