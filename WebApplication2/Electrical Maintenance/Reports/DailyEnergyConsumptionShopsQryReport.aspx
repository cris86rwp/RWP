<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DailyEnergyConsumptionShopsQryReport.aspx.vb" Inherits="WebApplication2.DailyEnergyConsumptionShopsQryReport" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD runat="server">
		<title>DailyEnergyConsumptionShopsQryReport</title>
		...
		<form id="Form2" method="post" runat="server">
			...
			<asp:panel id="Panel1" runat="server">
				<TABLE id="Table1" class="table">
					<TR>
						<TD align="middle" colSpan="2">Daily Energy Consumption&nbsp; Shopwise</TD>
					</TR>
					<TR>
						<TD style=colSpan="2">
