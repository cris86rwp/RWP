Public Class AdminEnergyConsumption
    ...
    Protected WithEvents lblMouldPHESS_month As System.Web.UI.WebControls.Label
    Protected WithEvents lblMouldPHESS_unit As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents lblTubePHESS_month As System.Web.UI.WebControls.Label
    Protected WithEvents lblTubePHESS_unit As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents lblFumePHESS_month As System.Web.UI.WebControls.Label
    Protected WithEvents lblFumePHESS_unit As System.Web.UI.WebControls.Label
    ...
    '        FillDDL(ddlMFkptcl, dtMF)
    '        FillDDL(ddlMFdgI, dtMF)
    '        FillDDL(ddlMFdgII, dtMF)
    '        FillDDL(ddlMFdgIII, dtMF)
    '        FillDDL(ddlMFarcA, dtMF)
    '        FillDDL(ddlMFarcB, dtMF)
    '        FillDDL(ddlMFarcC, dtMF)
    '        FillDDL(ddlMFpump, dtMF)
    '        FillDDL(ddlMFcol, dtMF)
    '        FillDDL(ddlMFadmn, dtMF)
    '        FillDDL(ddlMFaux, dtMF)
    '        FillDDL(ddlMFemms, dtMF)
    '        FillDDL(ddlMFdcos, dtMF)
    '        FillDDL(ddlMFrwfgen, dtMF)
    '    Catch exp As Exception
    '        lblMessage.Text = exp.Message
    '    End Try
    ...
    Private Sub getInitialValues()
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                'If Not IsDBNull(dt.Rows(0)(1)) Then txtKPTCL_initial.Text = dt.Rows(0)(1)
                'If Not IsDBNull(dt.Rows(0)(2)) Then txtDGGenI_initial.Text = dt.Rows(0)(2)
                'If Not IsDBNull(dt.Rows(0)(3)) Then txtDGGenII_initial.Text = dt.Rows(0)(3)
                'If Not IsDBNull(dt.Rows(0)(4)) Then txtArc1_initial.Text = dt.Rows(0)(4)
                'If Not IsDBNull(dt.Rows(0)(5)) Then txtArc2_initial.Text = dt.Rows(0)(5)
                'If Not IsDBNull(dt.Rows(0)(6)) Then txtArc3_initial.Text = dt.Rows(0)(6)
                'If Not IsDBNull(dt.Rows(0)(7)) Then txtPump_initial.Text = dt.Rows(0)(7)
                'If Not IsDBNull(dt.Rows(0)(8)) Then txtColony_initial.Text = dt.Rows(0)(8)
                'If Not IsDBNull(dt.Rows(0)(9)) Then txtAdmin_initial.Text = dt.Rows(0)(9)
                'If Not IsDBNull(dt.Rows(0)(10)) Then txtAux_initial.Text = dt.Rows(0)(10)
                'If Not IsDBNull(dt.Rows(0)(11)) Then txtSubstation_initial.Text = dt.Rows(0)(11)
                'If Not IsDBNull(dt.Rows(0)(12)) Then txtDCOS_initial.Text = dt.Rows(0)(12)
                'If Not IsDBNull(dt.Rows(0)(13)) Then SelectDDL(ddlMFkptcl, CStr(dt.Rows(0)(13)))
                'If Not IsDBNull(dt.Rows(0)(14)) Then SelectDDL(ddlMFdgI, CStr(dt.Rows(0)(14)))
                'If Not IsDBNull(dt.Rows(0)(15)) Then SelectDDL(ddlMFdgII, CStr(dt.Rows(0)(15)))
                'If Not IsDBNull(dt.Rows(0)(16)) Then SelectDDL(ddlMFarcA, CStr(dt.Rows(0)(16)))
                'If Not IsDBNull(dt.Rows(0)(17)) Then SelectDDL(ddlMFarcB, CStr(dt.Rows(0)(17)))
                'If Not IsDBNull(dt.Rows(0)(18)) Then SelectDDL(ddlMFarcC, CStr(dt.Rows(0)(18)))
                'If Not IsDBNull(dt.Rows(0)(19)) Then SelectDDL(ddlMFpump, CStr(dt.Rows(0)(19)))
                'If Not IsDBNull(dt.Rows(0)(20)) Then SelectDDL(ddlMFcol, CStr(dt.Rows(0)(20)))
                'If Not IsDBNull(dt.Rows(0)(21)) Then SelectDDL(ddlMFadmn, CStr(dt.Rows(0)(21)))
                'If Not IsDBNull(dt.Rows(0)(22)) Then SelectDDL(ddlMFaux, CStr(dt.Rows(0)(22)))
                'If Not IsDBNull(dt.Rows(0)(23)) Then SelectDDL(ddlMFemms, CStr(dt.Rows(0)(23)))
                'If Not IsDBNull(dt.Rows(0)(24)) Then SelectDDL(ddlMFdcos, CStr(dt.Rows(0)(24)))
                'If Not IsDBNull(dt.Rows(0)(25)) Then txtrwfgen_initial.Text = dt.Rows(0)(25)
                'If Not IsDBNull(dt.Rows(0)(26)) Then SelectDDL(ddlMFrwfgen, CStr(dt.Rows(0)(26)))
                'If Not IsDBNull(dt.Rows(0)(27)) Then txtDGGenIII_initial.Text = dt.Rows(0)(27)
                'If Not IsDBNull(dt.Rows(0)(28)) Then SelectDDL(ddlMFdgIII, CStr(dt.Rows(0)(28)))
            Else
    ...
    Sub getUnitsforMonth()
        ...
        Try
            ...
            If IsNothing(dt) = False Then
                ...
                lblTubePHESS_month.Text = IIf(IsDBNull(dt.Rows(0)("Tube")), 0, dt.Rows(0)("Tube"))
                lblMouldPHESS_month.Text = IIf(IsDBNull(dt.Rows(0)("Mould")), 0, dt.Rows(0)("Mould"))
                lblFumePHESS_month.Text = IIf(IsDBNull(dt.Rows(0)("Fume")), 0, dt.Rows(0)("Fume"))
                ...
                'lblKPTCL_month.Text = IIf(IsDBNull(dt.Rows(0)("kptcl")), 0, dt.Rows(0)("kptcl"))
                'lblDGGenI_month.Text = IIf(IsDBNull(dt.Rows(0)("dg1")), 0, dt.Rows(0)("dg1"))
                'lblDGGenII_month.Text = IIf(IsDBNull(dt.Rows(0)("dg2")), 0, dt.Rows(0)("dg2"))
                'lblDGGenIII_month.Text = IIf(IsDBNull(dt.Rows(0)("dg3")), 0, dt.Rows(0)("dg3"))
                'lblArc1_month.Text = IIf(IsDBNull(dt.Rows(0)("arc1")), 0, dt.Rows(0)("arc1"))
                'lblArc2_month.Text = IIf(IsDBNull(dt.Rows(0)("arc2")), 0, dt.Rows(0)("arc2"))
                'lblArc3_month.Text = IIf(IsDBNull(dt.Rows(0)("arc3")), 0, dt.Rows(0)("arc3"))
                'lblPump_month.Text = IIf(IsDBNull(dt.Rows(0)("pumphouse")), 0, dt.Rows(0)("pumphouse"))
                'lblColony_month.Text = IIf(IsDBNull(dt.Rows(0)("colony")), 0, dt.Rows(0)("colony"))
                'lblAdmin_month.Text = IIf(IsDBNull(dt.Rows(0)("admn")), 0, dt.Rows(0)("admn"))
                'lblAux_month.Text = IIf(IsDBNull(dt.Rows(0)("aux")), 0, dt.Rows(0)("aux"))
                'lblSubstation_month.Text = IIf(IsDBNull(dt.Rows(0)("emms")), 0, dt.Rows(0)("emms"))
                'lblDCOS_month.Text = IIf(IsDBNull(dt.Rows(0)("cos")), 0, dt.Rows(0)("cos"))
                'lblRwfgen_month.Text = IIf(IsDBNull(dt.Rows(0)("rwfgen")), 0, dt.Rows(0)("rwfgen"))
            End If
        Catch exp As Exception
            lblMessage.Text = exp.Message
    ...
    Sub getUnitsforDay()
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                'If Not IsDBNull(dt.Rows(0)(3)) Then txtDGGenI_initial.Text = dt.Rows(0)(3)
                'If Not IsDBNull(dt.Rows(0)(4)) Then txtDGGenI_final.Text = dt.Rows(0)(4)
                'If Not IsDBNull(dt.Rows(0)(5)) Then txtDGGenII_initial.Text = dt.Rows(0)(5)
                'If Not IsDBNull(dt.Rows(0)(6)) Then txtDGGenII_final.Text = dt.Rows(0)(6)
                'If Not IsDBNull(dt.Rows(0)(7)) Then txtArc1_initial.Text = dt.Rows(0)(7)
                'If Not IsDBNull(dt.Rows(0)(8)) Then txtArc1_final.Text = dt.Rows(0)(8)
                'If Not IsDBNull(dt.Rows(0)(9)) Then txtArc2_initial.Text = dt.Rows(0)(9)
                'If Not IsDBNull(dt.Rows(0)(10)) Then txtArc2_final.Text = dt.Rows(0)(10)
                'If Not IsDBNull(dt.Rows(0)(11)) Then txtArc3_initial.Text = dt.Rows(0)(11)
                'If Not IsDBNull(dt.Rows(0)(12)) Then txtArc3_final.Text = dt.Rows(0)(12)
                'If Not IsDBNull(dt.Rows(0)(13)) Then txtPump_initial.Text = dt.Rows(0)(13)
                'If Not IsDBNull(dt.Rows(0)(14)) Then txtPump_final.Text = dt.Rows(0)(14)
                'If Not IsDBNull(dt.Rows(0)(15)) Then txtColony_initial.Text = dt.Rows(0)(15)
                'If Not IsDBNull(dt.Rows(0)(16)) Then txtColony_final.Text = dt.Rows(0)(16)
                'If Not IsDBNull(dt.Rows(0)(17)) Then txtAdmin_initial.Text = dt.Rows(0)(17)
                'If Not IsDBNull(dt.Rows(0)(18)) Then txtAdmin_final.Text = dt.Rows(0)(18)
                'If Not IsDBNull(dt.Rows(0)(19)) Then txtAux_initial.Text = dt.Rows(0)(19)
                'If Not IsDBNull(dt.Rows(0)(20)) Then txtAux_final.Text = dt.Rows(0)(20)
                'If Not IsDBNull(dt.Rows(0)(21)) Then txtSubstation_initial.Text = dt.Rows(0)(21)
                'If Not IsDBNull(dt.Rows(0)(22)) Then txtSubstation_final.Text = dt.Rows(0)(22)
                'If Not IsDBNull(dt.Rows(0)(23)) Then txtDCOS_initial.Text = dt.Rows(0)(23)
                'If Not IsDBNull(dt.Rows(0)(24)) Then txtDCOS_final.Text = dt.Rows(0)(24)
                'If Not IsDBNull(dt.Rows(0)(25)) Then SelectDDL(ddlMFkptcl, CStr(dt.Rows(0)(25)))
                'If Not IsDBNull(dt.Rows(0)(26)) Then SelectDDL(ddlMFdgI, CStr(dt.Rows(0)(26)))
                'If Not IsDBNull(dt.Rows(0)(27)) Then SelectDDL(ddlMFdgII, CStr(dt.Rows(0)(27)))
                'If Not IsDBNull(dt.Rows(0)(28)) Then SelectDDL(ddlMFarcA, CStr(dt.Rows(0)(28)))
                'If Not IsDBNull(dt.Rows(0)(29)) Then SelectDDL(ddlMFarcB, CStr(dt.Rows(0)(29)))
                'If Not IsDBNull(dt.Rows(0)(30)) Then SelectDDL(ddlMFarcC, CStr(dt.Rows(0)(30)))
                'If Not IsDBNull(dt.Rows(0)(31)) Then SelectDDL(ddlMFpump, CStr(dt.Rows(0)(31)))
                'If Not IsDBNull(dt.Rows(0)(32)) Then SelectDDL(ddlMFcol, CStr(dt.Rows(0)(32)))
                'If Not IsDBNull(dt.Rows(0)(33)) Then SelectDDL(ddlMFadmn, CStr(dt.Rows(0)(33)))
                'If Not IsDBNull(dt.Rows(0)(34)) Then SelectDDL(ddlMFaux, CStr(dt.Rows(0)(34)))
                'If Not IsDBNull(dt.Rows(0)(35)) Then SelectDDL(ddlMFemms, CStr(dt.Rows(0)(35)))
                'If Not IsDBNull(dt.Rows(0)(36)) Then SelectDDL(ddlMFdcos, CStr(dt.Rows(0)(36)))
                'If Not IsDBNull(dt.Rows(0)(37)) Then txtrwfgen_initial.Text = dt.Rows(0)(37)
                'If Not IsDBNull(dt.Rows(0)(38)) Then txtrwfgen_final.Text = dt.Rows(0)(38)
                'If Not IsDBNull(dt.Rows(0)(39)) Then SelectDDL(ddlMFrwfgen, CStr(dt.Rows(0)(39)))
                'If Not IsDBNull(dt.Rows(0)(40)) Then txtDGGenIII_initial.Text = dt.Rows(0)(40)
                'If Not IsDBNull(dt.Rows(0)(41)) Then txtDGGenIII_initial.Text = dt.Rows(0)(41)
                'If Not IsDBNull(dt.Rows(0)(42)) Then SelectDDL(ddlMFdgIII, CStr(dt.Rows(0)(42)))
            Else
                Throw New Exception("No data for the Given Date !")
            End If
        Catch exp As Exception
    ...
    '        FillTexts(oAdmn, "dggen2", IIf(IsDBNull(txtDGGenII_initial.Text), 0.0, (Val(txtDGGenII_initial.Text))), IIf(IsDBNull(txtDGGenII_final.Text), 0.0, (Val(txtDGGenII_final.Text))), (Val(ddlMFdgII.SelectedItem.Text)), lblDIFF_dgII, lblDGGenII_month)
    '        FillTexts(oAdmn, "dggen3", IIf(IsDBNull(txtDGGenIII_initial.Text), 0.0, (Val(txtDGGenIII_initial.Text))), IIf(IsDBNull(txtDGGenIII_final.Text), 0.0, (Val(txtDGGenIII_final.Text))), (Val(ddlMFdgIII.SelectedItem.Text)), lblDIFF_dgIII, lblDGGenIII_month)
    ...
    '        FillTexts(oAdmn, "colony", IIf(IsDBNull(txtColony_initial.Text), 0.0, (Val(txtColony_initial.Text))), IIf(IsDBNull(txtColony_final.Text), 0.0, (Val(txtColony_final.Text))), (Val(ddlMFcol.SelectedItem.Text)), lblDIFF_col, lblColony_month)
    ...
    '        FillTexts(oAdmn, "dcos", IIf(IsDBNull(txtDCOS_initial.Text), 0.0, (Val(txtDCOS_initial.Text))), IIf(IsDBNull(txtDCOS_final.Text), 0.0, (Val(txtDCOS_final.Text))), (Val(ddlMFdcos.SelectedItem.Text)), lblDIFF_dcos, lblDCOS_month)
    ...
    Private Sub btnSubmit_Clicks_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSubmit_Clicks.Click
        ...
        Try
            ...
            FillTexts(oAdmn, "Tube", IIf(IsDBNull(TubePHESS_initial.Text), 0.0, (Val(TubePHESS_initial.Text))), IIf(IsDBNull(txtPump_final.Text), 0.0, (Val(txtPump_final.Text))), (Val(ddlMFpump.SelectedItem.Text)), lblDIFF_pump, lblPump_month)
            FillTexts(oAdmn, "Mould", IIf(IsDBNull(MouldPHESS_initial.Text), 0.0, (Val(MouldPHESS_initial.Text))), IIf(IsDBNull(TubePHESS_final.Text), 0.0, (Val(TubePHESS_final.Text))), (Val(ddlTubePHESS.SelectedItem.Text)), lblDIFF_TubePHESS, lblTubePHESS_month)
            FillTexts(oAdmn, "Fume", IIf(IsDBNull(FumePHESS_initial.Text), 0.0, (Val(FumePHESS_initial.Text))), IIf(IsDBNull(FumePHESS_final.Text), 0.0, (Val(FumePHESS_final.Text))), (Val(ddlFumePHESS.SelectedItem.Text)), lblDIFF_FumePHESS, lblFumePHESS_month)
            FillTexts(oAdmn, "emms", IIf(IsDBNull(txtSubstation_initial.Text), 0.0, (Val(txtSubstation_initial.Text))), IIf(IsDBNull(txtSubstation_final.Text), 0.0, (Val(txtSubstation_final.Text))), (Val(ddlMFemms.SelectedItem.Text)), lblDIFF_emms, lblSubstation_month)
            FillTexts(oAdmn, "colony", IIf(IsDBNull(txtColony12_initial.Text), 0.0, (Val(txtColony12_initial.Text))), IIf(IsDBNull(txtColony12_final.Text), 0.0, (Val(txtColony12_final.Text))), (Val(ddlMFcol12.SelectedItem.Text)), lblDIFF_col12, lblColony12_month)
            FillTexts(oAdmn, "colony", IIf(IsDBNull(txtColony34_initial.Text), 0.0, (Val(txtColony34_initial.Text))), IIf(IsDBNull(txtColony34_final.Text), 0.0, (Val(txtColony34_final.Text))), (Val(ddlMFcol34.SelectedItem.Text)), lblDIFF_col34, lblColony34_month)
            FillTexts(oAdmn, "adminbldg", IIf(IsDBNull(txtAdmin_initial.Text), 0.0, (Val(txtAdmin_initial.Text))), IIf(IsDBNull(txtAdmin_final.Text), 0.0, (Val(txtAdmin_final.Text))), (Val(ddlMFadmn.SelectedItem.Text)), lblDIFF_Admn, lblAdmin_month)
            FillTexts(oAdmn, "stnaux", IIf(IsDBNull(txtAux_initial.Text), 0.0, (Val(txtAux_initial.Text))), IIf(IsDBNull(txtAux_final.Text), 0.0, (Val(txtAux_final.Text))), (Val(ddlMFaux.SelectedItem.Text)), lblDIFF_aux, lblAux_month)
            FillTexts(oAdmn, "rwfgen", IIf(IsDBNull(txtrwfgen_initial.Text), 0.0, (Val(txtrwfgen_initial.Text))), IIf(IsDBNull(txtrwfgen_final.Text), 0.0, (Val(txtrwfgen_final.Text))), (Val(ddlMFrwfgen.SelectedItem.Text)), lblDIFF_rwfgen, lblRwfgen_month)
    ...
    'Private Sub txtDCOS_final_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDCOS_final.TextChanged
    '    lblMessage.Text = ""
    '    Try
    '        Try
    '            Dim d1, d2, val As Double
    '            d1 = txtDCOS_final.Text
    '            d2 = txtDCOS_initial.Text
    '            val = (d1 - d2)
    '            lblDIFF_dcos.Text = val
    '        Catch exp As Exception
    '            lblMessage.Text = "Enter Numeric Values"
    '            Exit Sub
    '        End Try
    '        If CDbl(txtDCOS_final.Text) < CDbl(txtDCOS_initial.Text) Then
    '            lblMessage.Text = "Final Reading is Less Than Initial"
    '            txtSubstation_initial.Text = ""
    '            Exit Sub
    '        End If
    '        If txtDCOS_final.Text = "" And txtDCOS_initial.Text = "" Then

    '        Else
    '            lblDCOS_unit.Text = CDbl(txtDCOS_final.Text) - CDbl(txtDCOS_initial.Text)
    '        End If
    '    Catch exp As Exception
    '        lblMessage.Text = exp.Message
    '    End Try
    ...
    Private Sub btnCalculateAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCalculateAll.Click
        Try
            lblKPTCL_month.Text = CStr(CDbl(lblKPTCL_unit.Text))
            lblDGGenI_month.Text = CStr(CDbl(lblDGGenI_unit.Text))
            lblDGGenII_month.Text = CStr(CDbl(lblDGGenII_unit.Text))
            lblDGGenIII_month.Text = CStr(CDbl(lblDGGenIII_unit.Text))
            lblArc1_month.Text = CStr(CDbl(lblArc1_unit.Text))
            lblArc2_month.Text = CStr(CDbl(lblArc2_unit.Text))
            lblArc3_month.Text = CStr(CDbl(lblArc3_unit.Text))
            lblPump_month.Text = CStr(CDbl(lblPump_unit.Text))
            lblColony_month.Text = CStr(CDbl(lblColony_unit.Text))
            lblAdmin_month.Text = CStr(CDbl(lblAdmin_unit.Text))
            lblAux_month.Text = CStr(CDbl(lblAux_unit.Text))
            lblSubstation_month.Text = CStr(CDbl(lblSubstation_unit.Text))
            'lblDCOS_month.Text = CStr(CDbl(lblDCOS_unit.Text))
            lblRwfgen_month.Text = CStr(CDbl(lblRwfgen_unit.Text))
        Catch exp As Exception
            lblMessage.Text = exp.Message
        End Try
    End Sub
    ...
    'Private Sub txtDGGenII_final_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDGGenII_final.TextChanged
    '    lblMessage.Text = ""
    '    Try
    '        Try
    '            Dim d1, d2, val As Double
    '            d1 = txtDGGenII_final.Text
    '            d2 = txtDGGenII_initial.Text
    '            val = (d1 - d2)
    '            lblDIFF_dgII.Text = val
    '        Catch exp As Exception
    '            lblMessage.Text = "Enter Numeric Values"
    '            Exit Sub
    '        End Try
    '        If CDbl(txtDGGenII_final.Text) < CDbl(txtDGGenII_initial.Text) Then
    '            lblMessage.Text = "Final Reading is Less Than Initial"
    '            txtDGGenII_initial.Text = ""
    '            Exit Sub
    '        End If
    '        If txtDGGenII_final.Text = "" And txtDGGenII_initial.Text = "" Then

    '        Else
    '            lblDGGenII_unit.Text = CDbl(txtDGGenII_final.Text) - CDbl(txtDGGenII_initial.Text)
    '        End If
    '    Catch exp As Exception
    '        lblMessage.Text = exp.Message
    '    End Try
    ...
    'Private Sub txtDGGenIII_final_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDGGenIII_final.TextChanged
    '    lblMessage.Text = ""
    '    Try
    '        Try
    '            Dim d1, d2, val As Double
    '            d1 = txtDGGenIII_final.Text
    '            d2 = txtDGGenIII_initial.Text
    '            val = (d1 - d2)
    '            lblDIFF_dgIII.Text = val
    '        Catch exp As Exception
    '            lblMessage.Text = "Enter Numeric Values"
    '            Exit Sub
    '        End Try
    '        If CDbl(txtDGGenIII_final.Text) < CDbl(txtDGGenIII_initial.Text) Then
    '            lblMessage.Text = "Final Reading is Less Than Initial"
    '            txtDGGenIII_initial.Text = ""
    '            Exit Sub
    '        End If
    '        If txtDGGenIII_final.Text = "" And txtDGGenIII_initial.Text = "" Then

    '        Else
    '            lblDGGenIII_unit.Text = CDbl(txtDGGenIII_final.Text) - CDbl(txtDGGenIII_initial.Text)
    '        End If
    '    Catch exp As Exception
    '        lblMessage.Text = exp.Message
    '    End Try
    ...
    'Private Sub ddlMFdgIII_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ddlMFdgIII.SelectedIndexChanged
    '    lblDGGenIII_unit.Text = Val(lblDIFF_dgIII.Text) * Val(ddlMFdgIII.SelectedItem.Text)
    'End Sub
End Class
