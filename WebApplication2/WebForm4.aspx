            ...
            <asp:label id="lblDate" runat="server"></asp:label></div >
             <div  class="col" >Breakdown MemoNo:&nbsp;&nbsp;<asp:label id="lblMemo" runat="server" ForeColor="Black"></asp:label>
               ...
               <div class="col">Machine: <asp:label id="Label1" runat="server"></asp:label> </div>
                           <b><div  class="col" align="right" >User:
				
							<asp:label id="lblUser" runat="server"></asp:label></div ></b>
					</div>
       <asp:label id="lblGroup" runat="server" Visible="false"></asp:label>
         <asp:label id="lblGroupID" runat="server" Visible="false"></asp:label>
            <br />
      <div class="row">
          <div class="col">SpareList:</div>
          <div class="col"><asp:dropdownlist id="ddlSparesList" CssClass="form-control ll" runat="server" AutoPostBack="True"></asp:dropdownlist>
									</div>
          <div class="col"> PL NO.:</div>
          <div class="col"><asp:textbox id="txtPLNumber" runat="server" CssClass="form-control" AutoPostBack="True" Enabled="False" ></asp:textbox>
										</div>
          <div class="col">Quantity:</div>
          <div class="col"><asp:textbox id="txtPlQty" runat="server" CssClass="form-control"></asp:textbox>
										</div>
      </div><br />
            <div class="row">
                <div class="col " align="center">
            <asp:button id="btnClose" runat="server" Text="Add PL"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button>&nbsp;
              </div></div><br />
            <asp:DataGrid id="grdSpares" runat="server" CssClass="table" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="4">
											<SelectedItemStyle Font-Bold="True" ForeColor="black" BackColor="#FFCC66"></SelectedItemStyle>
        ...
        <div class="row">
          <div class="col">Mechanical work</div>
            
          <div class="col"><asp:textbox id="Addwork" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:textbox></div>
  <div class="col">
                Remarks
                </div>
           
          <div class="col"><asp:textbox id="Remarks" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:textbox></div>
                </div>
           <br />
            <div class="row">
                <div class="col " align="center">
            <asp:button id="BtnClose1" runat="server" Text="Submit"  Font-Size="16px"  BorderStyle="Solid" Font-Bold="True"  CssClass="btn btn-dark" ></asp:button>&nbsp;
			</div></div>
            <br />
